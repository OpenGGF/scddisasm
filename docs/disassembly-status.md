...
| `ENDING.MMD` | `FMV/Main (Ending).asm` | L | Legacy | Opaque/mixed | 822 address labels and a large source-emitted image; dispatch, startup, VBlank, animation-table, and event-stream helpers now have semantic callers | Mixed | J/U/E | J/U/E 2026-09-03 (M352) | Recover one ending-FMV routine/data family |
