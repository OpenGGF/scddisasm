...
| `ENDING.MMD` | `FMV/Main (Ending).asm` | L | Legacy | Opaque/mixed | 822 address labels and a large source-emitted image; dispatch, startup/teardown, command-loader, VBlank transfer, event-stream emitter, Word RAM swap, joypad, name-table clear, timing, synchronization, and command-lifecycle helpers now have semantic callers | Mixed | J/U/E | J/U/E 2026-09-04 (M380) | Recover one ending-FMV routine/data family |
