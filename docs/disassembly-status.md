...
| `ATTACK.MMD` | `Time Attack/Main.asm` | L | Legacy | Opaque/mixed | About 1,600 address labels and a packed suffix; selected M342–M344 maps, dispatch tables, Sub CPU wrappers, and palette helpers now use semantic callers and data boundaries | Mixed | J/U/E | J/U/E 2026-09-03 (M346) | Recover one Time Attack routine family |
