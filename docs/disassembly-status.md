...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | H | Hybrid zone graph with semantic shared engine, object dispatch/services, and Sub CPU commands | Mixed; Present palette and object index structured | Recovered object implementations/section-art code, address labels, and padding/data tails | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M24) | Converge the next R31A recovered object cluster |
