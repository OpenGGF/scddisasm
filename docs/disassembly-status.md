...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | H | Hybrid zone graph with semantic shared engine; intro, saved-object despawn, shared objects through Projector, and animated-tile update semantically labelled | Mixed; Present palette, section-art tables, shared-object data, and animated-tile behavior structured | Graphics lists and later address-labelled/padding data tails | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M101) | Converge the Collision Chaos graphics-list family |
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, and animated-tile update semantically labelled | Mixed; Past palette, shared-object data, and no-op animated-tile behavior structured | Zone-specific scroll/draw/load, graphics lists, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M101) | Converge the Collision Chaos graphics-list family |
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, and animated-tile update semantically labelled | Mixed; Good Future palette, shared-object data, and no-op animated-tile behavior structured | Zone-specific scroll/draw/load, graphics lists, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M101) | Converge the Collision Chaos graphics-list family |
| `R31D__.MMD` | `Level/Collision Chaos/Act 1 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, and animated-tile update semantically labelled | Mixed; Bad Future palette, shared-object data, and no-op animated-tile behavior structured | Zone-specific scroll/draw/load, graphics lists, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M101) | Converge the Collision Chaos graphics-list family |
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, and animated-tile update semantically labelled | Mixed; Present palette/shared-object data and two-frame animated raw-tile windows structured | Zone-specific scroll/draw/load, graphics lists, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M101) | Converge the Collision Chaos graphics-list family |
...
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, and animated-tile update semantically labelled | Mixed; Good Future palette/shared-object data and two-frame animated raw-tile windows structured | Zone-specific scroll/draw/load, graphics lists, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M101) | Converge the Collision Chaos graphics-list family |
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, and animated-tile update semantically labelled | Mixed; Bad Future palette/shared-object data and two-frame animated raw-tile windows structured | Zone-specific scroll/draw/load, graphics lists, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M101) | Converge the Collision Chaos graphics-list family |
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss/Drain, shared objects through Projector, and animated-tile update semantically labelled | Mixed; Good Future palette, Results/boss/Drain data, shared-object data, and no-op animated-tile behavior structured | Graphics lists, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M101) | Converge the Collision Chaos graphics-list family |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss/Drain, shared objects through Projector, and animated-tile update semantically labelled | Mixed; Bad Future palette, Results/boss/Drain data, shared-object data, and no-op animated-tile behavior structured | Graphics lists, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M101) | Converge the Collision Chaos graphics-list family |
