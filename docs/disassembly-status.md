...
| `R62B__.MMD` | `Level/Wacky Workbench/Act 2 Past.asm` | S | Mostly semantic | Mixed | Packed/legacy data tails and residual generic labels; R62C continuation and R72A Padding 2 shared after `$027A`/`$0400` | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M292) | Classify active data debt, then relabel residual code |
| `R62C__.MMD` | `Level/Wacky Workbench/Act 2 Good Future.asm` | S | Mostly semantic | Mixed | Packed/legacy data tails and residual generic labels; non-USA continuation provider plus R72A Padding 2 shared with R62B/R72A/R72C | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M292) | Classify active data debt, then relabel residual code |
...
| `R72A__.MMD` | `Level/Stardust Speedway/Act 2 Present.asm` | H | Partial | Mixed | Hybrid common/objects/rN graph and packed/retained data; Padding 2 provider for R72C/R62B/R62C | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M292) | Converge this zone graph, then classify data |
...
| `R72C__.MMD` | `Level/Stardust Speedway/Act 2 Good Future.asm` | H | Partial | Mixed | Hybrid common/objects/rN graph and packed/retained data; R62C continuation and R72A Padding 2 shared after `$01CA`/full tail | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M292) | Converge this zone graph, then classify data |
