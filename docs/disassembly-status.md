...
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, boss-entry-barrier, boss-machine core, active combat, boss-defeat, and Eggman-pilot families semantically labelled; object time checks converged | Mixed; Good Future palette, animal, robot-generator, projector, Game Over, Title Card placement/mapping, Results-screen mapping, boss-combat tables, timed arena-explosion patterns, and Eggman animation/mapping records structured | Remaining boss child families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M78) | Recover the Collision Chaos linked gear child family |
