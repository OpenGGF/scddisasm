...
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy with semantic palette subsystem | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M7) | Converge Collision Chaos palette data |
...
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy with semantic palette subsystem | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M7) | Converge Collision Chaos palette data |
...
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial with semantic palette subsystem | Mixed | Hybrid R3/shared graph and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M7) | Converge Collision Chaos palette data |
