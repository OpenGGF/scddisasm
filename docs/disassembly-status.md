...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | H | Hybrid zone graph with semantic shared engine and expanding spin-tunnel/common-object cluster | Mixed; Present palette, object index, spring, ring, and monitor records structured | Remaining recovered object implementations/section-art code, address labels, and padding/data tails | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M42) | Converge the next R31A recovered object cluster |
