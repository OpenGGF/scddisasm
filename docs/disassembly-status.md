...
| `R13C__.MMD` | `Level/Palmtree Panic/Act 3 Good Future.asm` | S | Mostly semantic | Mixed | Packed/legacy data tails and residual generic labels; R13D pre-chunks shared after `$07C4` prefix | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M287) | Classify active data debt, then relabel residual code |
| `R13D__.MMD` | `Level/Palmtree Panic/Act 3 Bad Future.asm` | S | Mostly semantic | Mixed | Packed/legacy data tails and residual generic labels; R12D pre-chunks shared after `$0666` prefix | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M287) | Classify active data debt, then relabel residual code |
...
| `R41B__.MMD` | `Level/Tidal Tempest/Act 1 Past.asm` | L | Legacy | Opaque/mixed | Legacy R41 graph, address labels, and retained streams; non-USA pre-chunks provide R41C/R41D | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M286) | Migrate the R41 act graph |
| `R41C__.MMD` | `Level/Tidal Tempest/Act 1 Good Future.asm` | L | Legacy | Opaque/mixed | Legacy R41 graph, address labels, and retained streams; R41B pre-chunks shared after `$0428` prefix | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M286) | Migrate the R41 act graph |
| `R41D__.MMD` | `Level/Tidal Tempest/Act 1 Bad Future.asm` | L | Legacy | Opaque/mixed | Legacy R41 graph, address labels, and retained streams; R41C pre-chunks shared after `$0012` prefix | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M286) | Migrate the R41 act graph |
...
| `R62B__.MMD` | `Level/Wacky Workbench/Act 2 Past.asm` | S | Mostly semantic | Mixed | Packed/legacy data tails and residual generic labels; R62C continuation shared after `$027A` prefix | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M291) | Classify active data debt, then relabel residual code |
| `R62C__.MMD` | `Level/Wacky Workbench/Act 2 Good Future.asm` | S | Mostly semantic | Mixed | Packed/legacy data tails and residual generic labels; non-USA continuation provider for R62B/R72A/R72C | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M291) | Classify active data debt, then relabel residual code |
...
| `R72A__.MMD` | `Level/Stardust Speedway/Act 2 Present.asm` | H | Partial | Mixed | Hybrid common/objects/rN graph and packed/retained data; R62C continuation shared after `$01CA` prefix | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M291) | Converge this zone graph, then classify data |
...
| `R72C__.MMD` | `Level/Stardust Speedway/Act 2 Good Future.asm` | H | Partial | Mixed | Hybrid common/objects/rN graph and packed/retained data; R62C continuation shared after `$01CA` prefix | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M291) | Converge this zone graph, then classify data |
