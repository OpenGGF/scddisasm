...
| `R32B__.MMD` | `Level/Collision Chaos/Act 2 Past.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, animated tiles, and PLC graph semantically labelled | Mixed; retained `R32B Padding 1` structured through title-card element records at `$08F7` | Zone-specific scroll/draw/load, address labels, `R32B Padding 1` from `$08F8`, and `R32B Padding 2` | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M184) | Structure retained title-card mapping-offset table at `$08F8` |
