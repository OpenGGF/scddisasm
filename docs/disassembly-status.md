...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | H | Hybrid zone graph with semantic shared engine and expanding zone/common-object cluster; intro, shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, and Tentou families semantically labelled; object time checks converged | Mixed; Present palette, section-art tables, and shared-object data including Pocket and Tentou animations/mappings classified | Later recovered object implementations, address labels, and padding/data tails | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M86) | Converge the Collision Chaos Spike Chain family |
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, and Tentou families semantically labelled; object time checks converged | Mixed; Past palette and shared-object data including Pocket and Tentou animations/mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M86) | Converge the Collision Chaos Spike Chain family |
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, and Tentou families semantically labelled; object time checks converged | Mixed; Good Future palette and shared-object data including Pocket and Tentou animations/mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M86) | Converge the Collision Chaos Spike Chain family |
| `R31D__.MMD` | `Level/Collision Chaos/Act 1 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, and Tentou families semantically labelled; object time checks converged | Mixed; Bad Future palette and shared-object data including Pocket and Tentou animations/mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M86) | Converge the Collision Chaos Spike Chain family |
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, and Tentou families semantically labelled; object time checks converged | Mixed; Present palette and shared-object data including Pocket and Tentou animations/mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M86) | Converge the Collision Chaos Spike Chain family |
...
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, complete boss, Drain, inactive teleporter, Pocket, and Tentou families semantically labelled; object time checks converged | Mixed; Good Future palette, shared-object data, Results-screen mapping, complete boss data, Drain data, and Pocket/Tentou animations/mappings structured | Spike Chain and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M86) | Converge the Collision Chaos Spike Chain family |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, complete boss, Drain, inactive teleporter, Pocket, and Tentou families semantically labelled; object time checks converged | Mixed; Bad Future palette, shared-object data, Results-screen mapping, complete boss data, Drain data, and Pocket/Tentou animations/mappings structured | Spike Chain and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M86) | Converge the Collision Chaos Spike Chain family |
