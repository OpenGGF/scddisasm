...
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, animated tiles, PLC graph, and retained title-card fragment semantically labelled | Mixed; Present palette/shared-object data, animated tile windows, stage descriptor, PLC records, three-section layout table, and JE `$20F334-$20F42D` title-card fragment structured | Zone-specific scroll/draw/load, address labels, `R32A Padding 2`, JE `$20F2E4-$20F333` and `$20F42E-$20FFFF`, and the separate USA pre-chunk block | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M104) | Recover the JE `$20F42E-$20F6ED` retained Results fragment |
