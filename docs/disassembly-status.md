...
| `ATTACK.MMD` | `Time Attack/Main.asm` | L | Legacy | Opaque/mixed | About 1,600 address labels and a packed suffix; selection, rendering, transfer, palette, dispatch, initials-entry, highlight, tile-block, insertion, tile-map, Sub CPU command, and palette-step helpers now have semantic aliases | Mixed | J/U/E | J/U/E 2026-09-03 (M344) | Recover one Time Attack routine family |
...
| `ENDING.MMD` | `FMV/Main (Ending).asm` | L | Legacy | Opaque/mixed | 822 address labels and a large source-emitted image; main-state table and Word RAM command router now have semantic aliases | Mixed | J/U/E | J/U/E 2026-09-03 (M345) | Recover one ending-FMV routine/data family |
