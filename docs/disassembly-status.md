...
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, boss-entry-barrier, boss-machine core, and active boss-combat families semantically labelled; object time checks converged | Mixed; Good Future palette, animal, robot-generator, projector, Game Over, Title Card placement/mapping, Results-screen mapping, and boss-combat threshold/phase tables structured | Boss defeat movement and child families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M76) | Recover the Collision Chaos boss defeat movement/helper family |
