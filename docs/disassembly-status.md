...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | H | Hybrid zone graph with semantic shared engine; intro, saved-object despawn, and shared object families through Level End semantically labelled; object time checks converged | Mixed; Present palette, section-art tables, and shared-object data through KamaKama structured | Level End asset records and later recovered object implementations, address labels, and padding/data tails | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Level End semantically labelled; object time checks converged | Mixed; Past palette and shared-object data through KamaKama structured | Zone-specific scroll/draw/load, Level End asset records and later object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Level End semantically labelled; object time checks converged | Mixed; Good Future palette and shared-object data through KamaKama structured | Zone-specific scroll/draw/load, Level End asset records and later object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
| `R31D__.MMD` | `Level/Collision Chaos/Act 1 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Level End semantically labelled; object time checks converged | Mixed; Bad Future palette and shared-object data through KamaKama structured | Zone-specific scroll/draw/load, Level End asset records and later object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Level End semantically labelled; object time checks converged | Mixed; Present palette and shared-object data through KamaKama structured | Zone-specific scroll/draw/load, Level End asset records and later object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
| `R32B__.MMD` | `Level/Collision Chaos/Act 2 Past.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Level End semantically labelled; object time checks converged | Mixed; Past palette and shared-object data through KamaKama structured | Zone-specific scroll/draw/load, Level End asset records and later object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Level End semantically labelled; object time checks converged | Mixed; Good Future palette and shared-object data through KamaKama structured | Zone-specific scroll/draw/load, Level End asset records and later object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Level End semantically labelled; object time checks converged | Mixed; Bad Future palette and shared-object data through KamaKama structured | Zone-specific scroll/draw/load, Level End asset records and later object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss and Drain families, and shared object families through Level End semantically labelled; object time checks converged | Mixed; Good Future palette, Results/boss/Drain data, and shared-object data through KamaKama structured | Level End asset records and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss and Drain families, and shared object families through Level End semantically labelled; object time checks converged | Mixed; Bad Future palette, Results/boss/Drain data, and shared-object data through KamaKama structured | Level End asset records and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M96) | Structure the shared Level End animation and mapping data |
