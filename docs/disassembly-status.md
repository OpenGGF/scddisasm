...
| `THANKS_M.MMD` | `Thank You/Main.asm` | H | Partial | Opaque/mixed | 163 address labels and large declaration regions; connected display, hardware, palette, startup, object, screen-data, fade, dispatch, decoder, sprite-queue, and timer families are now canonical semantic labels | Mixed | J/U/E | J/U/E 2026-09-03 (M366) | Recover one Thank You routine/data family |
