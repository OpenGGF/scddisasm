...
| `R12C__.MMD` | `Level/Palmtree Panic/Act 2 Good Future.asm` | S | Mostly semantic | Mixed | Packed/legacy data tails and residual generic labels; USA retained helper routines and orphan PLC graph are shared and named; R12C Padding 3 is the structured shared tail provider | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M279) | Classify active data debt, then relabel residual code |
| `R12D__.MMD` | `Level/Palmtree Panic/Act 2 Bad Future.asm` | S | Mostly semantic | Mixed | Packed/legacy data tails and residual generic labels; USA retained helper routines and orphan PLC graph are shared and named; R12D Padding 3 reuses the R31C provider | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M279) | Classify active data debt, then relabel residual code |
