...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | H | Hybrid zone graph with semantic shared engine and expanding zone/common-object cluster; intro, shared animal, robot-generator, projector, Game Over, Title Card, Results, and inactive teleporter stub families semantically labelled; object time checks converged | Mixed; Present palette, section-art tables, object state/animation/mapping records structured; intro, animal, robot-generator, projector, Game Over, Title Card placement/mapping, Results-screen mapping, and empty teleporter mapping data classified | Later recovered object implementations, address labels, and padding/data tails | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M84) | Converge the next shared Collision Chaos object family |
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, and Results families semantically labelled; object time checks converged | Mixed; Past palette, animal, robot-generator, projector, Game Over, Title Card placement/mapping, and Results-screen mapping data structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M73) | Converge the next zone-specific routine cluster |
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, and Results families semantically labelled; object time checks converged | Mixed; Good Future palette, animal, robot-generator, projector, Game Over, Title Card placement/mapping, and Results-screen mapping data structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M73) | Converge the next zone-specific routine cluster |
| `R31D__.MMD` | `Level/Collision Chaos/Act 1 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, and Results families semantically labelled; object time checks converged | Mixed; Bad Future palette, animal, robot-generator, projector, Game Over, Title Card placement/mapping, and Results-screen mapping data structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M73) | Converge the next zone-specific routine cluster |
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, and Results families semantically labelled; object time checks converged | Mixed; Present palette, animal, robot-generator, projector, Game Over, Title Card placement/mapping, and Results-screen mapping data structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M73) | Converge the next zone-specific routine cluster |
...
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, complete boss, Drain, and inactive teleporter stub families semantically labelled; object time checks converged | Mixed; Good Future palette, shared-object data, Results-screen mapping, complete boss data, Drain animations/mappings, and empty teleporter mapping structured | Points Pocket and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M84) | Converge the Collision Chaos Points Pocket object family |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, complete boss, Drain, and inactive teleporter stub families semantically labelled; object time checks converged | Mixed; Bad Future palette, shared-object data, Results-screen mapping, complete boss data, Drain animations/mappings, and empty teleporter mapping structured | Points Pocket and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M84) | Converge the Collision Chaos Points Pocket object family |
