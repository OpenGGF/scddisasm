...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | L | Legacy with semantic palette/misc. functions | Mixed; Present palette structured | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy with semantic palette/misc. functions | Mixed; Past palette structured | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy with semantic palette/misc. functions | Mixed; Good Future palette structured | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
| `R31D__.MMD` | `Level/Collision Chaos/Act 1 Bad Future.asm` | L | Legacy with semantic palette/misc. functions | Mixed; Bad Future palette structured | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy with semantic palette/misc. functions | Mixed; Present palette structured | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
| `R32B__.MMD` | `Level/Collision Chaos/Act 2 Past.asm` | L | Legacy with semantic palette/misc. functions | Mixed; Past palette structured | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy with semantic palette/misc. functions | Mixed; Good Future palette structured | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy with semantic palette/misc. functions | Mixed; Bad Future palette structured | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial with semantic palette/misc. functions | Mixed; Good Future palette structured | Hybrid R3/shared graph and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial with semantic palette/misc. functions | Mixed; Bad Future palette structured | Hybrid R3/shared graph and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M14) | Converge the next shared engine routine cluster |
