...
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, complete boss, and Drain behavior families semantically labelled; object time checks converged | Mixed; Good Future palette, shared-object data, Results-screen mapping, complete boss data, and Drain animations/mappings structured | Teleporter and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M83) | Recover the Collision Chaos teleporter object family |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, complete boss, and Drain behavior families semantically labelled; object time checks converged | Mixed; Bad Future palette, shared-object data, Results-screen mapping, complete boss data, and Drain animations/mappings structured | Teleporter and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M83) | Recover the Collision Chaos teleporter object family |
