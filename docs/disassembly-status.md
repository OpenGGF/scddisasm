...
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy with semantic palette subsystem | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M7) | Converge Collision Chaos palette data |
...
| `R32B__.MMD` | `Level/Collision Chaos/Act 2 Past.asm` | L | Legacy with semantic palette subsystem | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M7) | Converge Collision Chaos palette data |
