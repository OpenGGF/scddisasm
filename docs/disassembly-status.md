...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | H | Hybrid zone graph with semantic shared engine; intro, saved-object despawn, and shared object families through Projector semantically labelled; object time checks converged | Mixed; Present palette, section-art tables, and shared-object data through Projector structured | Stage graphics animation and later address-labelled/padding data tails | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Projector semantically labelled; object time checks converged | Mixed; Past palette and shared-object data through Projector structured | Zone-specific scroll/draw/load, stage graphics animation, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Projector semantically labelled; object time checks converged | Mixed; Good Future palette and shared-object data through Projector structured | Zone-specific scroll/draw/load, stage graphics animation, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
| `R31D__.MMD` | `Level/Collision Chaos/Act 1 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Projector semantically labelled; object time checks converged | Mixed; Bad Future palette and shared-object data through Projector structured | Zone-specific scroll/draw/load, stage graphics animation, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Projector semantically labelled; object time checks converged | Mixed; Present palette and shared-object data through Projector structured | Zone-specific scroll/draw/load, stage graphics animation, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
| `R32B__.MMD` | `Level/Collision Chaos/Act 2 Past.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Projector semantically labelled; object time checks converged | Mixed; Past palette and shared-object data through Projector structured | Zone-specific scroll/draw/load, stage graphics animation, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Projector semantically labelled; object time checks converged | Mixed; Good Future palette and shared-object data through Projector structured | Zone-specific scroll/draw/load, stage graphics animation, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core and shared object families through Projector semantically labelled; object time checks converged | Mixed; Bad Future palette and shared-object data through Projector structured | Zone-specific scroll/draw/load, stage graphics animation, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss and Drain families, and shared object families through Projector semantically labelled; object time checks converged | Mixed; Good Future palette, Results/boss/Drain data, and shared-object data through Projector structured | Stage graphics animation, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss and Drain families, and shared object families through Projector semantically labelled; object time checks converged | Mixed; Bad Future palette, Results/boss/Drain data, and shared-object data through Projector structured | Stage graphics animation, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M100) | Converge the Collision Chaos stage graphics animation family |
