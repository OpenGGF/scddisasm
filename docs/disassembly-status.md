...
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, animated tiles, and PLC graph semantically labelled | Mixed; Good Future palette/shared-object data, shared R33 collision-geometry metadata at `$0000-$0083`, collision-column tail at `$0084-$01C1`, collision-row map at `$01C2-$11C1`, Act 1 Past collision-index map at `$11C2-$14E1`, relative layout-pointer table at `$14E2-$1529`, Act 1 Past foreground/background layouts at `$152A-$164B`/`$164C-$1663`, null targets, GHZ2/GHZ3 fallback layouts, shared Wacky Workbench suffix, and R32C Padding 3 shared mapping/animation and rotation-vector suffix structured | Zone-specific scroll/draw/load, address labels, and remaining R32C Padding 1 prefix | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M262) | Classify remaining R32C/R32D padding streams |
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, animated tiles, and PLC graph semantically labelled | Mixed; Bad Future palette/shared-object data, collision-column tail at `$0000-$013D`, shared collision-row map at `$013E-$113D`, Act 1 Past collision-index map at `$113E-$145D`, relative layout-pointer table at `$145E-$14A5`, Act 1 Past foreground/background layouts at `$14A6-$15C7`/`$15C8-$15DF`, null targets, GHZ2/GHZ3 fallback layouts, shared Wacky Workbench suffix, and R32C-shared Padding 1 tail at `$0030-$0E59` structured | Zone-specific scroll/draw/load, address labels, and unique R32D Padding 1 prefix `$0000-$002F` | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M262) | Classify remaining R32C/R32D padding streams |
