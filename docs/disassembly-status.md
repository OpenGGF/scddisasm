...
| `ATTACK.MMD` | `Time Attack/Main.asm` | L | Legacy | Opaque/mixed | About 1,600 address labels and a packed suffix; selection, rendering, transfer, palette, and dispatch helpers now have semantic aliases | Mixed | J/U/E | J/U/E 2026-09-03 (M334) | Recover one Time Attack routine family |
