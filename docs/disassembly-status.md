...
| `ATTACK.MMD` | `Time Attack/Main.asm` | L | Legacy | Opaque/mixed | About 1,600 address labels and a packed suffix; selection, rendering, transfer, palette, dispatch, initials-entry, highlight, tile-block, insertion, and time-record tile-map helpers now have semantic aliases | Mixed | J/U/E | J/U/E 2026-09-03 (M342) | Recover one Time Attack routine family |
