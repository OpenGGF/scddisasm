...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R71A__.MMD` | `Level/Stardust Speedway/Act 1 Present.asm` | H | Partial | Mixed | Hybrid common/objects/rN graph and packed/retained data; packed Prefix provider for R71B/R71C | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M289) | Converge this zone graph, then classify data |
| `R71B__.MMD` | `Level/Stardust Speedway/Act 1 Past.asm` | H | Partial | Mixed | Hybrid common/objects/rN graph and packed/retained data; R71A packed prefix shared after `$0514` | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M289) | Converge this zone graph, then classify data |
| `R71C__.MMD` | `Level/Stardust Speedway/Act 1 Good Future.asm` | H | Partial | Mixed | Hybrid common/objects/rN graph and packed/retained data; R71A packed prefix shared after `$08D0` | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M289) | Converge this zone graph, then classify data |
