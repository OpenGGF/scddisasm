...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | H | Hybrid zone graph with semantic shared engine; intro and shared object families plus saved-object despawn semantically labelled; object time checks converged | Mixed; Present palette, section-art tables, and shared-object data through Drum Platform structured | Later recovered object implementations, address labels, and padding/data tails | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy zone graph with semantic shared engine core, shared object families through Drum Platform, and saved-object despawn semantically labelled; object time checks converged | Mixed; Past palette and shared-object data through Drum Platform structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy zone graph with semantic shared engine core, shared object families through Drum Platform, and saved-object despawn semantically labelled; object time checks converged | Mixed; Good Future palette and shared-object data through Drum Platform structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
| `R31D__.MMD` | `Level/Collision Chaos/Act 1 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core, shared object families through Drum Platform, and saved-object despawn semantically labelled; object time checks converged | Mixed; Bad Future palette and shared-object data through Drum Platform structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy zone graph with semantic shared engine core, shared object families through Drum Platform, and saved-object despawn semantically labelled; object time checks converged | Mixed; Present palette and shared-object data through Drum Platform structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
| `R32B__.MMD` | `Level/Collision Chaos/Act 2 Past.asm` | L | Legacy zone graph with semantic shared engine core, shared object families through Drum Platform, and saved-object despawn semantically labelled; object time checks converged | Mixed; Past palette and shared-object data through Drum Platform structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy zone graph with semantic shared engine core, shared object families through Drum Platform, and saved-object despawn semantically labelled; object time checks converged | Mixed; Good Future palette and shared-object data through Drum Platform structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core, shared object families through Drum Platform, and saved-object despawn semantically labelled; object time checks converged | Mixed; Bad Future palette and shared-object data through Drum Platform structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss and Drain families, shared object families through Drum Platform, and saved-object despawn semantically labelled; object time checks converged | Mixed; Good Future palette, Results/boss/Drain data, and shared-object data through Drum Platform structured | KamaKama and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss and Drain families, shared object families through Drum Platform, and saved-object despawn semantically labelled; object time checks converged | Mixed; Bad Future palette, Results/boss/Drain data, and shared-object data through Drum Platform structured | KamaKama and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M94) | Converge the Collision Chaos KamaKama family |
