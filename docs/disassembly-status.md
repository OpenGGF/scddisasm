...
| `ATTACK.MMD` | `Time Attack/Main.asm` | L | Legacy | Opaque/mixed | About 1,600 address labels and a packed suffix; synchronization, VDP, period, time, VInterrupt, transfer, I/O, and rotated-upload helpers now have semantic aliases | Mixed | J/U/E | J/U/E 2026-09-03 (M312) | Recover one Time Attack routine family |
