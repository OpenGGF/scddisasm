...
| `ATTACK.MMD` | `Time Attack/Main.asm` | L | Legacy | Opaque/mixed | About 1,600 address labels and a packed suffix; selected map, dispatch, palette, Sub CPU, VDP-wait, hardware helper, and time-period selection/animation families are canonical semantic labels with migrated callers | Mixed | J/U/E | J/U/E 2026-09-04 (M392) | Recover one Time Attack routine family |
