...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | L | Legacy | Opaque/mixed | Legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 | Migrate the matching R31 or R32 act graph |
...
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy | Opaque/mixed | Legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 | Migrate the matching R31 or R32 act graph |
