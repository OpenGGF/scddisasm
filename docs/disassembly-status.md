...
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, animated tiles, PLC graph, and retained title-card/Results fragments semantically labelled | Mixed; Present palette/shared-object data, animated tile windows, stage descriptor, PLC records, three-section layout table, regional title-card fragments including placement/mapping records, complete regional Results executable units and mapping frames, retained animated/static PLC metadata and helpers, retained Collision Chaos and orphaned stage/PLC graphs, `DEMO11A` PLC slices, Quartz break-wall table tail, and USA pre-chunk PLC prefix structured | Zone-specific scroll/draw/load, address labels, `R32A Padding 2`, and USA pre-chunk tail `$20FFE8-$20FFFF`; the complete JE pre-chunk block is classified | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M130) | Classify the truncated USA PLC fragment at `$20FFE8-$20FFFF` and finish the pre-chunk block |
| `R32B__.MMD` | `Level/Collision Chaos/Act 2 Past.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, animated tiles, and PLC graph semantically labelled | Mixed; Past palette/shared-object data, stage descriptor, PLC records, and three-section layout table structured | Zone-specific scroll/draw/load, address labels, and `R32B Padding 1/2` streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M103) | Classify exact code/table ranges in the R32B padding streams |
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, animated tiles, and PLC graph semantically labelled | Mixed; Good Future palette/shared-object data, animated tile windows, stage descriptor, PLC records, and three-section layout table structured | Zone-specific scroll/draw/load, address labels, and `R32C Padding 1/2` streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M103) | Classify exact code/table ranges in the R32C padding streams |
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, animated tiles, and PLC graph semantically labelled | Mixed; Bad Future palette/shared-object data, animated tile windows, stage descriptor, PLC records, and three-section layout table structured | Zone-specific scroll/draw/load, address labels, and `R32D Padding 1/2` streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M103) | Classify exact code/table ranges in the R32D padding streams |
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss/Drain, shared objects through Projector, animated tiles, and PLC graph semantically labelled | Mixed; Good Future palette, Results/boss/Drain data, shared-object data, stage descriptor, and boss/escape PLC records structured | Hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M102) | Classify the Collision Chaos variant data tails |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial zone graph with semantic shared engine core, complete boss/Drain, shared objects through Projector, animated tiles, and PLC graph semantically labelled | Mixed; Bad Future palette, Results/boss/Drain data, shared-object data, stage descriptor, and boss/escape PLC records structured | Hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M102) | Classify the Collision Chaos variant data tails |
