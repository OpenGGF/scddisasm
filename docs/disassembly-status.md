...
| `ATTACK.MMD` | `Time Attack/Main.asm` | L | Legacy | Opaque/mixed | About 1,600 address labels and a packed suffix; selection, rendering, transfer, palette, dispatch, initials-entry, highlight, tile-block, and insertion helpers now have semantic aliases | Mixed | J/U/E | J/U/E 2026-09-03 (M339) | Recover one Time Attack routine family |
...
| `THANKS_M.MMD` | `Thank You/Main.asm` | H | Partial | Opaque/mixed | 163 address labels and large declaration regions; display-state, hardware, palette, startup, object, screen-data, fade, dispatch, and decoder helpers now have semantic aliases | Mixed | J/U/E | J/U/E 2026-09-03 (M340) | Recover one Thank You routine/data family |
