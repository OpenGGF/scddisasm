...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | H | Hybrid zone graph with semantic shared engine and expanding zone/common-object cluster; intro, shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Present palette, section-art tables, and shared-object data including Pocket, Tentou, and Spike Chain mappings classified | Later recovered object implementations, address labels, and padding/data tails | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Past palette and shared-object data including Pocket, Tentou, and Spike Chain mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Good Future palette and shared-object data including Pocket, Tentou, and Spike Chain mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
| `R31D__.MMD` | `Level/Collision Chaos/Act 1 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Bad Future palette and shared-object data including Pocket, Tentou, and Spike Chain mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Present palette and shared-object data including Pocket, Tentou, and Spike Chain mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
| `R32B__.MMD` | `Level/Collision Chaos/Act 2 Past.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Past palette and shared-object data including Pocket, Tentou, and Spike Chain mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Good Future palette and shared-object data including Pocket, Tentou, and Spike Chain mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Bad Future palette and shared-object data including Pocket, Tentou, and Spike Chain mappings structured | Zone-specific scroll/draw/load, object code, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, complete boss, Drain, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Good Future palette, shared-object data, Results-screen mapping, complete boss data, Drain data, and Pocket/Tentou/Spike Chain mappings structured | Spikes and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, complete boss, Drain, inactive teleporter, Pocket, Tentou, and Spike Chain families semantically labelled; object time checks converged | Mixed; Bad Future palette, shared-object data, Results-screen mapping, complete boss data, Drain data, and Pocket/Tentou/Spike Chain mappings structured | Spikes and later zone-object families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M87) | Converge the Collision Chaos Spikes family |
