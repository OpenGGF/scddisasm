...
| `ATTACK.MMD` | `Time Attack/Main.asm` | L | Legacy | Opaque/mixed | About 1,600 address labels and a packed suffix; semantic routine naming is ongoing | Mixed | J/U/E | J/U/E 2026-09-03 (M328) | Recover one Time Attack routine family |
...
| `THANKS_M.MMD` | `Thank You/Main.asm` | H | Partial | Opaque/mixed | 163 address labels and large declaration regions; display-state, hardware, palette, startup, and object helpers now have semantic aliases | Mixed | J/U/E | J/U/E 2026-09-03 (M324) | Recover one Thank You routine/data family |
