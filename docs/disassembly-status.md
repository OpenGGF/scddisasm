...
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy zone graph with semantic shared engine core, shared objects through Projector, animated tiles, and PLC graph semantically labelled | Mixed; Bad Future palette/shared-object data, animated tile windows, stage descriptor, PLC records, three-section layout table, and shared collision-row map at `$013E-$113D` structured | Zone-specific scroll/draw/load, address labels, and remaining `R32D Padding 1/2` ranges | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-03 (M254) | Classify remaining R32C/R32D padding streams |
