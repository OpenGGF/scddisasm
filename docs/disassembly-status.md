...
| `ENDING.MMD` | `FMV/Main (Ending).asm` | L | Legacy | Opaque/mixed | 822 address labels and a large source-emitted image; dispatch, startup, VBlank, event-stream, timer, and Word RAM synchronization helpers now have semantic callers | Mixed | J/U/E | J/U/E 2026-09-03 (M353) | Recover one ending-FMV routine/data family |
