...
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial zone graph with semantic shared engine core; shared animal, robot-generator, projector, Game Over, Title Card, Results, and boss-entry-barrier families semantically labelled; object time checks converged | Mixed; Good Future palette, animal, robot-generator, projector, Game Over, Title Card placement/mapping, and Results-screen mapping data structured | Remaining boss-machine families, hybrid R3 zone graph, address labels, and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-02 (M74) | Recover the next Collision Chaos boss-machine state family |
