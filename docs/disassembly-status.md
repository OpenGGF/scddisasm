...
| Output | Entry point | Graph | Code | Data | Unresolved labels/ranges | Binary assets | Regions/switches | Validation | Next milestone |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R31A__.MMD` | `Level/Collision Chaos/Act 1 Present.asm` | L | Legacy with semantic palette cycle/loaders | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
| `R31B__.MMD` | `Level/Collision Chaos/Act 1 Past.asm` | L | Legacy with semantic palette loaders | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
| `R31C__.MMD` | `Level/Collision Chaos/Act 1 Good Future.asm` | L | Legacy with semantic palette loaders | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
| `R31D__.MMD` | `Level/Collision Chaos/Act 1 Bad Future.asm` | L | Legacy with semantic palette loaders | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
| `R32A__.MMD` | `Level/Collision Chaos/Act 2 Present.asm` | L | Legacy with semantic palette cycle/loaders | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
| `R32B__.MMD` | `Level/Collision Chaos/Act 2 Past.asm` | L | Legacy with semantic palette loaders | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
| `R32C__.MMD` | `Level/Collision Chaos/Act 2 Good Future.asm` | L | Legacy with semantic palette loaders | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
| `R32D__.MMD` | `Level/Collision Chaos/Act 2 Bad Future.asm` | L | Legacy with semantic palette loaders | Opaque/mixed | Remaining legacy entry graph, address labels, and padding streams | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
| `R33C__.MMD` | `Level/Collision Chaos/Act 3 Good Future.asm` | H | Partial with semantic palette loaders | Mixed | Hybrid R3/shared graph and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
| `R33D__.MMD` | `Level/Collision Chaos/Act 3 Bad Future.asm` | H | Partial with semantic palette loaders | Mixed | Hybrid R3/shared graph and packed data | Mixed but mostly named | J/U/E DEMO=0 | J/U/E 2026-09-01 (M6) | Converge the palette fading engine |
