...
R11Events:
	...
	bne.s	R12Events
	cmpi.w	#$1C16,(player_object+obj.x).w
	bcs.s	loc_203564
	cmpi.w	#$21C6,(player_object+obj.x).w
	bcc.s	loc_203564
	move.w	#$88,(scroll_focus_y).w

loc_203564:
	move.w	#$710,(target_bottom_bound).w
	cmpi.w	#$840,(scroll_fg_x).w
	bcs.s	locret_2035A2
	tst.b	(update_hud_time).l
	beq.s	loc_20358E
	cmpi.w	#$820,(left_bound).w
	bcc.s	loc_20358E
	move.w	#$820,(left_bound).w
	move.w	#$820,(target_left_bound).w

loc_20358E:
	move.w	#$410,(target_bottom_bound).w
	cmpi.w	#$E00,(scroll_fg_x).w
	bcs.s	locret_2035A2
...
R53Events:
	...
	tst.b	(boss_flags).w
	bne.s	loc_203698
	move.w	#$320,(target_bottom_bound).w
...
loc_203698:
	move.w	#$1F8,(bottom_bound).w
	move.w	#$1F8,(target_bottom_bound).w
	rts
...
loc_2036D4:
	move.w	#$10C,d0
	move.w	d0,(top_bound).w
	move.w	d0,(target_top_bound).w
	move.w	d0,(bottom_bound).w
	move.w	d0,(target_bottom_bound).w
	rts
...
R73Events:
	...
	cmpi.w	#$930,obj.x(a1)
	bge.s	loc_20379C
	move.w	#$210,(target_bottom_bound).w
	rts
