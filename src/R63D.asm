...
; ------------------------------------------------------------------------------
	...
	include "src/r6/palette_cycle_d.asm"
	...
	include "src/r6/scroll_3d.asm"
	include "src/r6/stage_draw_3d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r6/stage_data_load_3d.asm"
	...
	include "src/r6/section_gfx_3d.asm"
	...
	include "src/r6/stage_gfx_animate_3d.asm"
	include "src/r6/gfx_lists_3d.asm"
	include "src/objects/r6/boss.asm"
	include "src/r6/data_3d.asm"
