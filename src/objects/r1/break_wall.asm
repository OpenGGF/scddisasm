...
BreakWallSprites:
	dc.w	@BreakWallSprites_0-*
	dc.w	@BreakWallSprites_1-BreakWallSprites
	dc.w	@BreakWallSprites_2-BreakWallSprites
	dc.w	@BreakWallSprites_3-BreakWallSprites
	dc.w	@BreakWallSprites_4-BreakWallSprites
	dc.w	@BreakWallSprites_5-BreakWallSprites
	dc.w	@BreakWallSprites_6-BreakWallSprites
	dc.w	@BreakWallSprites_7-BreakWallSprites
	dc.w	@BreakWallSprites_8-BreakWallSprites
	dc.w	@BreakWallSprites_9-BreakWallSprites
	dc.w	@BreakWallSprites_A-BreakWallSprites
	dc.w	@BreakWallSprites_B-BreakWallSprites
	dc.w	@BreakWallSprites_C-BreakWallSprites
	dc.w	@BreakWallSprites_D-BreakWallSprites
