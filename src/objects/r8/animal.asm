...
AnimalObject:
	...
	move.w	off_20E65A(pc,d0.w),d0
	jmp	off_20E65A(pc,d0.w)

; ------------------------------------------------------------------------------

off_20E65A:
	dc.w	AnimalObject_1_Routine0-*
	dc.w	AnimalObject_1_Routine2-off_20E65A
...
loc_20E6F8:
	moveq	#0,d0
	move.b	obj.routine(a0),d0
	move.w	off_20E706(pc,d0.w),d0
	jmp	off_20E706(pc,d0.w)

; ------------------------------------------------------------------------------

off_20E706:
	dc.w	AnimalObject_0_Routine0-*
	dc.w	AnimalObject_0_Routine2-off_20E706
...
AnimalAnims:
	include	"anims/r8/animal.asm"
	even

AnimalSprites1:
	include	"sprites/r8/animal_1.asm"
	even

AnimalSprites2:
	include	"sprites/r8/animal_2.asm"
	even
