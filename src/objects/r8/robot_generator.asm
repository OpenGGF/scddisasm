...
RobotGeneratorObject:
	...
	move.w	off_20E434(pc,d0.w),d0
	jsr	off_20E434(pc,d0.w)
	jsr	DrawObject
...
off_20E434:
	...
	dc.w	RobotGeneratorMain-off_20E434
	dc.w	RobotGeneratorExplode-off_20E434
	dc.w	RobotGeneratorDestroyed-off_20E434
