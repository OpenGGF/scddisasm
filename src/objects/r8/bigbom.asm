...
BigbomFuseAnims:
	include	"anims/r8/bigbom_fuse.asm"
	even

BigbomFuseSprites:
	include	"sprites/r8/bigbom_fuse.asm"
	even
...
BigbomExplodeAnims:
	include	"anims/r8/bigbom_explode.asm"
	even

BigbomExplodeSprites:
	include	"sprites/r8/bigbom_explode.asm"
	even
...
BigbomDebrisAnims:
	include	"anims/r8/bigbom_debris.asm"
	even

BigbomDebrisSprites:
	include	"sprites/r8/bigbom_debris.asm"
	even
