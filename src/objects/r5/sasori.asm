...
SasoriAnims:
	include	"anims/r5/sasori.asm"
	even

SasoriSprites1:
	include	"sprites/r5/sasori_1.asm"
	even

SasoriSprites2:
	include	"sprites/r5/sasori_2.asm"
	even

SasoriGunSprites:
	include	"sprites/r5/sasori_gun.asm"
	even

SasoriMissileAnims:
	include	"anims/r5/sasori_missile.asm"
	even

SasoriMissileSprites:
	include	"sprites/r5/sasori_missile.asm"
	even
