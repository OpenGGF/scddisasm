...
BossExplodeAnims:
	include	"anims/r5/boss_explode.asm"
	even
...
BossTopSprites:
	include	"sprites/r5/boss_top.asm"
	even

BossBoothSprites:
	include	"sprites/r5/boss_booth.asm"
	even

BossBackSprites:
	include	"sprites/r5/boss_back.asm"
	even

EggmanAnims:
	include	"anims/r5/eggman.asm"
	even

EggmanSprites:
	include	"sprites/r5/eggman.asm"
	even

BossPipesSprites:
	include	"sprites/r5/boss_pipes.asm"
	even

BombDropAnims:
	include	"anims/r5/bomb_drop.asm"
	even

BombDropSprites:
	include	"sprites/r5/bomb_drop.asm"
	even

BombSprites:
	include	"sprites/r5/bomb.asm"
	even

SparksAnims:
	include	"anims/r5/sparks.asm"
	even

SparksSprites:
	include	"sprites/r5/sparks.asm"
	even

SpikeWallSprites:
	include	"sprites/r5/spike_wall.asm"
	even
