...
RobotGeneratorObject:
	...
	move.w	off_20F2B8(pc,d0.w),d0
	jsr	off_20F2B8(pc,d0.w)
	jsr	DrawObject
...
off_20F2B8:
	...
	dc.w	RobotGeneratorMain-off_20F2B8
	dc.w	RobotGeneratorExplode-off_20F2B8
	dc.w	RobotGeneratorDestroyed-off_20F2B8
...
RobotGeneratorInit:
	...
	move.l	#byte_20F6A6,obj.var_2c(a0)
