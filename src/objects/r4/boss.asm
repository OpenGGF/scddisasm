...
EggmanAnims:
	include	"anims/r4/eggman.asm"
	even

EggmanSprites:
	include	"sprites/r4/eggman.asm"
	even

EggMobileSprites:
	include	"sprites/r4/eggmobile.asm"
	even

BossMissileAnims:
	include	"anims/r4/boss_missile.asm"
	even

BossMissileSprites:
	include	"sprites/r4/boss_missile.asm"
	even

BossBubbleAnims:
	include	"anims/r4/boss_bubble.asm"
	even

BossBubbleSprites:
	include	"sprites/r4/boss_bubble.asm"
	even
