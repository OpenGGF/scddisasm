...
MetalSonicObject_1_RoutineA:
	...
	move.w	#$20,d0
	if (REGION=USA)&((R7_VARIANT=9)|(R7_VARIANT=10))
		tst.b	$FF156A.l
...
BossLaserImpactAnims:
	include	"anims/r7/boss_laser_impact.asm"
	even
...
EggmanAnims:
	include	"anims/r7/eggman.asm"
	even

EggmanSprites:
	include	"sprites/r7/eggman.asm"
	even

BossLaserAnims:
	include	"anims/r7/boss_laser.asm"
	even

BossLaserSprites:
	include	"sprites/r7/boss_laser.asm"
	even

BossExhaustAnims:
	include	"anims/r7/boss_exhaust.asm"
	even

BossExhaustSprites:
	include	"sprites/r7/boss_exhaust.asm"
	even

MetalSonicAnims:
	include	"anims/r7/metal_sonic.asm"
	even

MetalSonicSprites:
	include	"sprites/r7/metal_sonic.asm"
	even

ElectricShieldSprites:
	include	"sprites/r7/electric_shield.asm"
	even

MetalSonicDebrisSprites:
	include	"sprites/r7/metal_sonic_debris.asm"
	even

DebrisSprites:
	include	"sprites/r7/debris.asm"
	even
