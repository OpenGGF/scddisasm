...
StageChunks:
	incbin	"src/maps/r11a/chunks.bin"
	even
...
StageCollision:
	incbin	"src/maps/r11a/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r11a/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r11a/background.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r11a/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r11a/gfx.nem"
	even
