...
Padding1:
	incbin	"padding/r11d_e_1.bin"

StageChunks:
	incbin	"src/maps/r11d/chunks.bin"
	even
...
byte_21D7A6:
	incbin	"src/data/r11d/byte_21D7A6.bin"
	even
...
StageCollision:
	incbin	"src/maps/r11d/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r11d/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r11d/background.bin"
	even

StageMapNull:
	incbin	"src/data/r11d/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r11d/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r11d/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r11d/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r11d/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r11d/StageMapUnk5.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r11d/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r11d/gfx.nem"

Padding3:
	incbin	"padding/r11d_e_3.bin"
