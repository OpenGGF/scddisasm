...
loc_202998:
	...
	moveq	#0,d1
	move.w	(a1)+,d1
	move.w	d1,(player_object+obj.x).w
	moveq	#0,d0
	move.w	(a1),d0
	move.w	d0,(player_object+obj.y).w
...
sub_2029F2:
	cmpi.w	#$800,(player_object+obj.x).w
	bcs.s	loc_202A06
	subi.w	#$1E0,d0
	bcs.s	loc_202A02
	lsr.w	#1,d0
...
loc_202A4C:
	...
	moveq	#0,d5
	btst	#1,(player_object+obj.var_2c).w
	beq.s	loc_202A8C
	tst.w	(scroll_x_move).w
	beq.s	loc_202A8C
	move.w	(player_object+obj.x_speed).w,d5
	ext.l	d5
	asl.l	#8,d5
...
ScrollFgY:
	...
	btst	#2,(player_object+obj.flags).w
	beq.s	loc_202DF0
	subq.w	#5,d0
...
loc_202E22:
	...
	bne.s	loc_202E4A
	move.w	(player_object+obj.ground_speed).w,d1
	bpl.s	loc_202E32
	neg.w	d1
...
loc_202E92:
	...
	bgt.s	loc_202EB6
	andi.w	#$7FF,d1
	andi.w	#$7FF,(player_object+obj.y).w
