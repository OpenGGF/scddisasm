...
StageChunks:
	incbin	"src/maps/r13d/chunks.bin"
	even
...
StageCollision:
	incbin	"src/maps/r13d/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r13d/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r13d/background.bin"
	even

StageMapNull:
	incbin	"src/data/r13d/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r13d/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r13d/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r13d/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r13d/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r13d/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r13d/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r13d/gfx.nem"
	even
