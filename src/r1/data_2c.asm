...
StageChunks:
	incbin	"src/maps/r12c/chunks.bin"
	even
...
StageCollision:
	incbin	"src/maps/r12c/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r12c/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r12c/background.bin"
	even

StageMapNull:
	incbin	"src/data/r12c/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r12c/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r12c/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r12c/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r12c/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r12c/StageMapUnk5.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r12c/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r12c/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r12c/byte_21D7A6.bin"
	even
