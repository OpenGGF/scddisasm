...
StageChunks:
	incbin	"src/maps/r12d/chunks.bin"
	even
...
StageCollision:
	incbin	"src/maps/r12d/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r12d/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r12d/background.bin"
	even

StageMapNull:
	incbin	"src/data/r12d/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r12d/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r12d/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r12d/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r12d/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r12d/StageMapUnk5.bin"
...
StageBlocks:
	incbin	"src/maps/r12d/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r12d/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r12d/byte_21D7A6.bin"
	even
