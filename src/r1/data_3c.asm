...
StageChunks:
	incbin	"src/maps/r13c/chunks.bin"
	even

BossMachineGfx:
	incbin	"src/data/r13c/BossMachineGfx.bin"
	even

EggmanGfx:
	incbin	"src/data/r13c/EggmanGfx.bin"
...
StageCollision:
	incbin	"src/maps/r13c/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r13c/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r13c/background.bin"
	even

StageMapNull:
	incbin	"src/data/r13c/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r13c/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r13c/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r13c/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r13c/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r13c/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r13c/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r13c/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r13c/byte_21D7A6.bin"
	even
