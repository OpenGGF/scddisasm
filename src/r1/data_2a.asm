...
StageChunks:
	incbin	"src/maps/r12a/chunks.bin"
	even
...
byte_21D7A6:
	incbin	"src/data/r12a/byte_21D7A6.bin"
	even
...
StageCollision:
	incbin	"src/maps/r12a/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r12a/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r12a/background.bin"
	even

StageMapNull:
	incbin	"src/data/r12a/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r12a/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r12a/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r12a/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r12a/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r12a/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r12a/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r12a/gfx.nem"
