...
Padding1:
	if REGION=USA
		incbin	"../padding/r81c_e_1.bin",0,$125C
		include	"Level/USA Legacy Stage Tail B.asm"
		incbin	"../padding/r81c_e_1.bin",$125C,$16
	else
		incbin	"../padding/r81c_e_1.bin"
	endif

StageChunks:
	incbin	"maps/r81c/chunks.bin"
...
byte_2352CA:
	incbin	"data/r8/byte_2352CA_1c.bin"
	even
...
StageCollision:
	incbin	"maps/r81c/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r81c/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r81c/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r81c/blocks.nem"
	even

StageGfx:
	incbin	"maps/r81c/gfx.nem"
	even
