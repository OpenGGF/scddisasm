...
StageChunks:
	incbin	"maps/r81a/chunks.bin"

Padding2:
	include	"Level/Metallic Madness/Data/R81 Padding 2.asm"
...
byte_235FCA:
	incbin	"data/r8/byte_235FCA_1a.bin"
	even
...
StageCollision:
	incbin	"maps/r81a/collision.bin"
	even
...
StageMaps:
	...
	dc.w	StageMapUnk5-StageMaps
StageMapFg:
	incbin	"maps/r81a/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r81a/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r81a/blocks.nem"
	even

StageGfx:
	incbin	"maps/r81a/gfx.nem"
	even
...
Padding3:
	include	"Level/Metallic Madness/Data/R81A Stage Data Tail.asm"
