...
; ------------------------------------------------------------------------------
	...
	include "src/r4/palette_cycle_d.asm"
	...
	include "src/r4/scroll_3d.asm"
	include "src/r4/stage_draw_3d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r4/stage_data_load_3d.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r4/object_index_3.asm"
	...
	include "src/r4/debug_objects_3.asm"
	include "src/common/object_spawn.asm"
	include "src/r4/stage_object_maps_3.asm"
	...
	include "src/r4/water_currents_3.asm"
	include "src/r4/section_gfx_3d.asm"
	...
	include "src/objects/r4/boss_chase.asm"
	include "src/objects/r4/boss.asm"
	include "src/common/time_check.asm"
	include "src/r4/stage_gfx_animate_3d.asm"
	include "src/r4/gfx_lists_3d.asm"
	include "src/r4/data_3d.asm"
