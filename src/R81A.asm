...
; ------------------------------------------------------------------------------
	...
	include "src/r8/palette_cycle_a.asm"
	...
	include "src/r8/scroll_1a.asm"
	include "src/r8/stage_draw_1a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r8/stage_data_load_1a.asm"
	include "src/r8/events.asm"
	include "src/common/object.asm"
	include "src/r8/object_index_1.asm"
	...
	include "src/r8/debug_objects_1.asm"
	include "src/common/object_spawn.asm"
	include "src/r8/stage_object_maps_1.asm"
	...
	include "src/r8/section_gfx_1.asm"
	include "src/objects/r8/trap_1.asm"
	include "src/objects/r8/hv_platform.asm"
	include "src/objects/r8/mecha_bu.asm"
	include "src/objects/r8/collapse_floor.asm"
	include "src/objects/r8/buzzsaw.asm"
	include "src/objects/r8/propeller.asm"
	include "src/objects/r8/door.asm"
	include "src/objects/r8/spin_platform_1.asm"
	include "src/objects/r8/vanish_platform.asm"
	include "src/objects/r8/switch.asm"
	include "src/objects/r8/poh_bee.asm"
	include "src/objects/r8/scarab.asm"
	...
	include "src/r8/stage_gfx_animate_1a.asm"
	include "src/r8/gfx_lists_1a.asm"
	include "src/r8/data_1a.asm"
