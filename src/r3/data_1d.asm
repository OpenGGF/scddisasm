...
StageChunks:
	incbin	"src/maps/r31d/chunks.bin"
	even

MetalPlatformGfx:
	incbin	"src/data/r31d/MetalPlatformGfx.bin"
	even
...
BlockGfx:
	incbin	"src/data/r31d/BlockGfx.bin"
	even

RetractBlockGfx:
	incbin	"src/data/r31d/RetractBlockGfx.bin"
	even

OneWayBarrierGfx:
	incbin	"src/data/r31d/OneWayBarrierGfx.bin"
	even

FireShooterGfx:
	incbin	"src/data/r31d/FireShooterGfx.bin"
	even

RotatePlatformGfx:
	incbin	"src/data/r31d/RotatePlatformGfx.bin"
	even

KamaKamaGfx:
	incbin	"src/data/r31d/KamaKamaGfx.bin"
	even

SpikesGfx2:
	incbin	"src/data/r31d/SpikesGfx2.bin"
	even

KamaKamaSprites1:
	include	"src/data/r31d/KamaKamaSprites1.asm"
	even

KamaKamaSprites2:
	include	"src/data/r31d/KamaKamaSprites2.asm"
...
byte_233A9A:
	incbin	"src/data/r31d/byte_233A9A.bin"
	even

FlipperGfx:
	incbin	"src/data/r31d/FlipperGfx.bin"
	even

BumperGfx:
	incbin	"src/data/r31d/BumperGfx.bin"
	even

GaGfx:
	incbin	"src/data/r31d/GaGfx.bin"
	even

TentouGfx:
	incbin	"src/data/r31d/TentouGfx.bin"
	even

TentouBombGfx:
	incbin	"src/data/r31d/TentouBombGfx.bin"
	even

TeleporterGfx:
	incbin	"src/data/r31d/TeleporterGfx.bin"
	even

PointsPocketGfx:
	incbin	"src/data/r31d/PointsPocketGfx.bin"
	even

BossBarrierGfx:
	incbin	"src/data/r31d/BossBarrierGfx.bin"
	even

BossDrainBlockGfx:
	incbin	"src/data/r31d/BossDrainBlockGfx.bin"
	even

BouncePlatformGfx:
	incbin	"src/data/r31d/BouncePlatformGfx.bin"
	even

GlassShatterGfx:
	incbin	"src/data/r31d/GlassShatterGfx.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r31d/SpikeBallGfx.bin"
	even

BossBarrierGfx2:
	incbin	"src/data/r31d/BossBarrierGfx2.bin"
	even

Art_Boss:
	incbin	"src/data/r31d/Art_Boss.bin"
	even

EggmanEscapeGfx:
	incbin	"src/data/r31d/EggmanEscapeGfx.bin"
	even
...
BossBombLauncherGfx:
	incbin	"src/data/r31d/BossBombLauncherGfx.bin"
	even
...
StageCollision:
	incbin	"src/maps/r31d/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r31d/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r31d/background.bin"
	even

StageMapNull:
	incbin	"src/data/r31d/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r31d/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r31d/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r31d/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r31d/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r31d/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r31d/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r31d/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r31d/byte_21D7A6.bin"
	even
