...
StageCollision:
	incbin	"maps/r33d/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r33d/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r33d/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r33d/blocks.nem"
	even

StageGfx:
	incbin	"maps/r33d/gfx.nem"
	even
...
Padding3:
	include	"Level/Collision Chaos/Data/R33D Padding3 Packed Prefix.asm"
