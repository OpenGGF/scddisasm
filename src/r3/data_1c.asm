...
StageChunks:
	incbin	"src/maps/r31c/chunks.bin"
	even

MetalPlatformGfx:
	incbin	"src/data/r31c/MetalPlatformGfx.bin"
	even
...
BlockGfx:
	incbin	"src/data/r31c/BlockGfx.bin"
	even

RetractBlockGfx:
	incbin	"src/data/r31c/RetractBlockGfx.bin"
	even

OneWayBarrierGfx:
	incbin	"src/data/r31c/OneWayBarrierGfx.bin"
	even

FireShooterGfx:
	incbin	"src/data/r31c/FireShooterGfx.bin"
	even

RotatePlatformGfx:
	incbin	"src/data/r31c/RotatePlatformGfx.bin"
	even

KamaKamaGfx:
	incbin	"src/data/r31c/KamaKamaGfx.bin"
	even

SpikesGfx2:
	incbin	"src/data/r31c/SpikesGfx2.bin"
	even

KamaKamaSprites1:
	include	"src/data/r31c/KamaKamaSprites1.asm"
	even

KamaKamaSprites2:
	include	"src/data/r31c/KamaKamaSprites2.asm"
...
byte_233A9A:
	incbin	"src/data/r31c/byte_233A9A.bin"
	even

FlipperGfx:
	incbin	"src/data/r31c/FlipperGfx.bin"
	even

BumperGfx:
	incbin	"src/data/r31c/BumperGfx.bin"
	even

GaGfx:
	incbin	"src/data/r31c/GaGfx.bin"
	even

TentouGfx:
	incbin	"src/data/r31c/TentouGfx.bin"
	even

TentouBombGfx:
	incbin	"src/data/r31c/TentouBombGfx.bin"
	even

TeleporterGfx:
	incbin	"src/data/r31c/TeleporterGfx.bin"
	even

PointsPocketGfx:
	incbin	"src/data/r31c/PointsPocketGfx.bin"
	even

BossBarrierGfx:
	incbin	"src/data/r31c/BossBarrierGfx.bin"
	even

BossDrainBlockGfx:
	incbin	"src/data/r31c/BossDrainBlockGfx.bin"
	even

BouncePlatformGfx:
	incbin	"src/data/r31c/BouncePlatformGfx.bin"
	even

GlassShatterGfx:
	incbin	"src/data/r31c/GlassShatterGfx.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r31c/SpikeBallGfx.bin"
	even

BossBarrierGfx2:
	incbin	"src/data/r31c/BossBarrierGfx2.bin"
	even

Art_Boss:
	incbin	"src/data/r31c/Art_Boss.bin"
	even

EggmanEscapeGfx:
	incbin	"src/data/r31c/EggmanEscapeGfx.bin"
	even
...
BossBombLauncherGfx:
	incbin	"src/data/r31c/BossBombLauncherGfx.bin"
	even
...
StageCollision:
	incbin	"src/maps/r31c/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r31c/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r31c/background.bin"
	even

StageMapNull:
	incbin	"src/data/r31c/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r31c/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r31c/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r31c/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r31c/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r31c/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r31c/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r31c/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r31c/byte_21D7A6.bin"
	even
