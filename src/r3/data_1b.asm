...
FlipperGfx:
	incbin	"src/data/r31b/FlipperGfx.bin"
	even

BumperGfx:
	incbin	"src/data/r31b/BumperGfx.bin"
	even

MetalPlatformGfx:
	incbin	"src/data/r31b/MetalPlatformGfx.bin"
	even
...
BlockGfx:
	incbin	"src/data/r31b/BlockGfx.bin"
	even

RetractBlockGfx:
	incbin	"src/data/r31b/RetractBlockGfx.bin"
	even

OneWayBarrierGfx:
	incbin	"src/data/r31b/OneWayBarrierGfx.bin"
	even

FireShooterGfx:
	incbin	"src/data/r31b/FireShooterGfx.bin"
	even

RotatePlatformGfx:
	incbin	"src/data/r31b/RotatePlatformGfx.bin"
	even

KamaKamaGfx:
	incbin	"src/data/r31b/KamaKamaGfx.bin"
	even

SpikesGfx2:
	incbin	"src/data/r31b/SpikesGfx2.bin"
	even

KamaKamaSprites1:
	include	"src/data/r31b/KamaKamaSprites1.asm"
	even

KamaKamaSprites2:
	include	"src/data/r31b/KamaKamaSprites2.asm"
	even

GaGfx:
	incbin	"src/data/r31b/GaGfx.bin"
	even

TentouGfx:
	incbin	"src/data/r31b/TentouGfx.bin"
	even

TentouBombGfx:
	incbin	"src/data/r31b/TentouBombGfx.bin"
	even

TeleporterGfx:
	incbin	"src/data/r31b/TeleporterGfx.bin"
	even

PointsPocketGfx:
	incbin	"src/data/r31b/PointsPocketGfx.bin"
	even

BossBarrierGfx:
	incbin	"src/data/r31b/BossBarrierGfx.bin"
	even

BouncePlatformGfx:
	incbin	"src/data/r31b/BouncePlatformGfx.bin"
	even

GlassShatterGfx:
	incbin	"src/data/r31b/GlassShatterGfx.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r31b/SpikeBallGfx.bin"
	even
...
byte_21D7A6:
	incbin	"src/data/r31b/byte_21D7A6.bin"
	even
