...
Padding1:
	incbin	"padding/r33c_e_1.bin"

StageChunks:
	incbin	"src/maps/r33c/chunks.bin"
	even

MetalPlatformGfx:
	incbin	"src/data/r33c/MetalPlatformGfx.bin"
	even
...
BlockGfx:
	incbin	"src/data/r33c/BlockGfx.bin"
	even

RetractBlockGfx:
	incbin	"src/data/r33c/RetractBlockGfx.bin"
	even

OneWayBarrierGfx:
	incbin	"src/data/r33c/OneWayBarrierGfx.bin"
	even

FireShooterGfx:
	incbin	"src/data/r33c/FireShooterGfx.bin"
	even

RotatePlatformGfx:
	incbin	"src/data/r33c/RotatePlatformGfx.bin"
	even

KamaKamaGfx:
	incbin	"src/data/r33c/KamaKamaGfx.bin"
	even

SpikesGfx2:
	incbin	"src/data/r33c/SpikesGfx2.bin"
	even

KamaKamaSprites1:
	include	"src/data/r33c/KamaKamaSprites1.asm"
	even

KamaKamaSprites2:
	include	"src/data/r33c/KamaKamaSprites2.asm"
...
FlipperGfx:
	incbin	"src/data/r33c/FlipperGfx.bin"
	even

BumperGfx:
	incbin	"src/data/r33c/BumperGfx.bin"
	even

GaGfx:
	incbin	"src/data/r33c/GaGfx.bin"
	even

TentouGfx:
	incbin	"src/data/r33c/TentouGfx.bin"
	even

TentouBombGfx:
	incbin	"src/data/r33c/TentouBombGfx.bin"
	even

TeleporterGfx:
	incbin	"src/data/r33c/TeleporterGfx.bin"
	even

PointsPocketGfx:
	incbin	"src/data/r33c/PointsPocketGfx.bin"
	even

BossBarrierGfx:
	incbin	"src/data/r33c/BossBarrierGfx.bin"
	even

BossDrainBlockGfx:
	incbin	"src/data/r33c/BossDrainBlockGfx.bin"
	even

BouncePlatformGfx:
	incbin	"src/data/r33c/BouncePlatformGfx.bin"
	even

GlassShatterGfx:
	incbin	"src/data/r33c/GlassShatterGfx.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r33c/SpikeBallGfx.bin"
	even

BossBarrierGfx2:
	incbin	"src/data/r33c/BossBarrierGfx2.bin"
	even

Art_Boss:
	incbin	"src/data/r33c/Art_Boss.bin"
	even

EggmanEscapeGfx:
	incbin	"src/data/r33c/EggmanEscapeGfx.bin"
	even
...
BossBombLauncherGfx:
	incbin	"src/data/r33c/BossBombLauncherGfx.bin"
	even
...
StageCollision:
	incbin	"src/maps/r33c/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r33c/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r33c/background.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r33c/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r33c/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r33c/byte_21D7A6.bin"
	even
