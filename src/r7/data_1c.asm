...
StageChunks:
	incbin	"src/maps/r71c/chunks.bin"

Padding2:
	incbin	"padding/r71c_e_2.bin"
...
LauncherGfx:
	incbin	"src/data/r71c/LauncherGfx.bin"
	even

LauncherSparksGfx:
	incbin	"src/data/r71c/LauncherSparksGfx.bin"
	even

LightEdgesGfx:
	incbin	"src/data/r71c/LightEdgesGfx.bin"
	even

PathSwapPanelGfx:
	incbin	"src/data/r71c/PathSwapPanelGfx.bin"
	even

MeshGfxA:
	incbin	"src/data/r71c/MeshGfxA.bin"
	even

MeshGfxB:
	incbin	"src/data/r71c/MeshGfxB.bin"
	even

MeshGfxC:
	incbin	"src/data/r71c/MeshGfxC.bin"
	even

MeshGfxD:
	incbin	"src/data/r71c/MeshGfxD.bin"
	even
...
StageCollision:
	incbin	"src/maps/r71c/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r71c/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r71c/background.bin"
	even

StageMapNull:
	incbin	"src/data/r71c/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r71c/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r71c/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r71c/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r71c/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r71c/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r71c/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r71c/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r71c/byte_21D7A6.bin"
	even
...
SwingGfx:
	incbin	"src/data/r71c/SwingGfx.bin"
	even

LightsGfxA:
	incbin	"src/data/r71c/LightsGfxA.bin"
	even

LightsGfxC:
	incbin	"src/data/r71c/LightsGfxC.bin"
	even

LightsGfxD:
	incbin	"src/data/r71c/LightsGfxD.bin"
	even
...
KanabunGfx:
	incbin	"src/data/r71c/KanabunGfx.bin"
	even

SpikeLauncherGfx:
	incbin	"src/data/r71c/SpikeLauncherGfx.bin"
	even

BlockGfxA:
	incbin	"src/data/r71c/BlockGfxA.bin"
	even

BlockGfxB:
	incbin	"src/data/r71c/BlockGfxB.bin"
	even

BlockGfxC:
	incbin	"src/data/r71c/BlockGfxC.bin"
	even

BlockGfxD:
	incbin	"src/data/r71c/BlockGfxD.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r71c/SpikeBallGfx.bin"
	even

HotaruGfx:
	incbin	"src/data/r71c/HotaruGfx.bin"
	even

KabasiraGfx:
	incbin	"src/data/r71c/KabasiraGfx.bin"

Padding3:
	incbin	"padding/r71c_e_3.bin"
