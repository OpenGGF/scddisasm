...
Padding1:
	if REGION=USA
		include	"Level/USA Legacy R71C Prefix.asm"
...
StageChunks:
	incbin	"maps/r71c/chunks.bin"

Padding2:
	include	"Level/Stardust Speedway/Data/R71C Padding 2.asm"
...
StageCollision:
	incbin	"maps/r71c/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r71c/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r71c/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r71c/blocks.nem"
	even

StageGfx:
	incbin	"maps/r71c/gfx.nem"
	even
...
Padding3:
	include	"Level/Stardust Speedway/Data/R71C Padding3 Packed Prefix.asm"
