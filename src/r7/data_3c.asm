...
StageCollision:
	incbin	"maps/r73c/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r73c/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r73c/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r73c/blocks.nem"
	even

StageGfx:
	incbin	"maps/r73c/gfx.nem"
	even
