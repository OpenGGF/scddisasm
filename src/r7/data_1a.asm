...
StageCollision:
	incbin	"maps/r71a/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r71a/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r71a/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r71a/blocks.nem"
	even

StageGfx:
	incbin	"maps/r71a/gfx.nem"
	even
