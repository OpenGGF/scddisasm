...
Padding1:
	...
	dc.w	$75C0, $0023, $DA22, $78C0, $0023, $C8C4, $7D20, $0023
	dc.w	$DBF6, $8BA0, $0000, $0023, $C778, $75C0, $0000, $0022
	dc.w	$F8FC, $75C0, $0000, $0023, $0098, $7880, $0002, $0022
	dc.w	$FABC, $8780, $0022, $F4F2, $9100, $0020, $B63A, $7DE0
...
StageCollision:
	incbin	"maps/r71b/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r71b/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r71b/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r71b/blocks.nem"
	even

StageGfx:
	incbin	"maps/r71b/gfx.nem"
	even
