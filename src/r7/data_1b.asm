...
LauncherGfx:
	incbin	"src/data/r71b/LauncherGfx.bin"
	even

LauncherSparksGfx:
	incbin	"src/data/r71b/LauncherSparksGfx.bin"
	even

LightEdgesGfx:
	incbin	"src/data/r71b/LightEdgesGfx.bin"
	even

PathSwapPanelGfx:
	incbin	"src/data/r71b/PathSwapPanelGfx.bin"
	even

MeshGfxA:
	incbin	"src/data/r71b/MeshGfxA.bin"
	even

MeshGfxB:
	incbin	"src/data/r71b/MeshGfxB.bin"
	even

MeshGfxC:
	incbin	"src/data/r71b/MeshGfxC.bin"
	even

MeshGfxD:
	incbin	"src/data/r71b/MeshGfxD.bin"
	even
...
StageMapNull:
	incbin	"src/data/r71b/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r71b/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r71b/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r71b/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r71b/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r71b/StageMapUnk5.bin"
	even
...
byte_21D7A6:
	incbin	"src/data/r71b/byte_21D7A6.bin"
	even
...
SwingGfx:
	incbin	"src/data/r71b/SwingGfx.bin"
	even

LightsGfxA:
	incbin	"src/data/r71b/LightsGfxA.bin"
	even

LightsGfxC:
	incbin	"src/data/r71b/LightsGfxC.bin"
	even

LightsGfxD:
	incbin	"src/data/r71b/LightsGfxD.bin"
	even
...
KanabunGfx:
	incbin	"src/data/r71b/KanabunGfx.bin"
	even

SpikeLauncherGfx:
	incbin	"src/data/r71b/SpikeLauncherGfx.bin"
	even

BlockGfxA:
	incbin	"src/data/r71b/BlockGfxA.bin"
	even

BlockGfxB:
	incbin	"src/data/r71b/BlockGfxB.bin"
	even

BlockGfxC:
	incbin	"src/data/r71b/BlockGfxC.bin"
	even

BlockGfxD:
	incbin	"src/data/r71b/BlockGfxD.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r71b/SpikeBallGfx.bin"
	even

HotaruGfx:
	incbin	"src/data/r71b/HotaruGfx.bin"
	even

KabasiraGfx:
	incbin	"src/data/r71b/KabasiraGfx.bin"
	even

DangoGfx:
	incbin	"src/data/r71b/DangoGfx.bin"
