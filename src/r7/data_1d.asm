...
Padding1:
	if REGION=USA
		include	"Level/USA Legacy R71D Prefix.asm"
	...
	dc.w	$B5AC, $6CC0, $0023, $CD4E, $6EC0, $0023, $CF8A, $70C0
	dc.w	$0023, $CA62, $71C0, $0023, $B96C, $72C0, $0022, $F8FC
	dc.w	$75C0, $0023, $D524, $78C0, $0023, $C3C6, $7D20, $0023
	dc.w	$D04A, $8BA0, $0000, $0023, $0098, $7880, $0002, $0022
	dc.w	$FABC, $8780, $0022, $F4F2, $9100, $0020, $B6FC, $7DE0
		include	"r7/nonusa_padding_1c_1.asm"
	endif

StageChunks:
	incbin	"maps/r71d/chunks.bin"

Padding2:
	include	"Level/Stardust Speedway/Data/R71D Padding 2.asm"
...
StageCollision:
	incbin	"maps/r71d/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r71d/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r71d/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r71d/blocks.nem"
	even

StageGfx:
	incbin	"maps/r71d/gfx.nem"
	even
...
Padding3:
	include	"Level/Stardust Speedway/Data/R71D Padding3 Packed Prefix.asm"
