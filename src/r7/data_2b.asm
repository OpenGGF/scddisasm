...
StageCollision:
	incbin	"maps/r72b/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r72b/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r72b/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r72b/blocks.nem"
	even

StageGfx:
	incbin	"maps/r72b/gfx.nem"
	even
...
Padding3:
	include	"Level/Stardust Speedway/Data/R72B Padding3 Packed Prefix.asm"
