...
StageCollision:
	incbin	"maps/r72c/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r72c/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r72c/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r72c/blocks.nem"
	even

StageGfx:
	incbin	"maps/r72c/gfx.nem"
	even
...
Padding3:
	include	"Level/Stardust Speedway/Data/R72C Padding3 Shared Prefix.asm"
	if REGION=USA
