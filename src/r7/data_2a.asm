...
StageChunks:
	incbin	"src/maps/r72a/chunks.bin"
...
LauncherGfx:
	incbin	"src/data/r72a/LauncherGfx.bin"
	even

LauncherSparksGfx:
	incbin	"src/data/r72a/LauncherSparksGfx.bin"
	even

LightEdgesGfx:
	incbin	"src/data/r72a/LightEdgesGfx.bin"
	even

PathSwapPanelGfx:
	incbin	"src/data/r72a/PathSwapPanelGfx.bin"
	even

MeshGfxA:
	incbin	"src/data/r72a/MeshGfxA.bin"
	even

MeshGfxB:
	incbin	"src/data/r72a/MeshGfxB.bin"
	even

MeshGfxC:
	incbin	"src/data/r72a/MeshGfxC.bin"
	even

MeshGfxD:
	incbin	"src/data/r72a/MeshGfxD.bin"
	even
...
StageCollision:
	incbin	"src/maps/r72a/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r72a/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r72a/background.bin"
	even

StageMapNull:
	incbin	"src/data/r72a/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r72a/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r72a/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r72a/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r72a/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r72a/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r72a/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r72a/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r72a/byte_21D7A6.bin"
	even
...
SwingGfx:
	incbin	"src/data/r72a/SwingGfx.bin"
	even

LightsGfxA:
	incbin	"src/data/r72a/LightsGfxA.bin"
	even

LightsGfxC:
	incbin	"src/data/r72a/LightsGfxC.bin"
	even

LightsGfxD:
	incbin	"src/data/r72a/LightsGfxD.bin"
	even
...
KanabunGfx:
	incbin	"src/data/r72a/KanabunGfx.bin"
	even

SpikeLauncherGfx:
	incbin	"src/data/r72a/SpikeLauncherGfx.bin"
	even

BlockGfxA:
	incbin	"src/data/r72a/BlockGfxA.bin"
	even

BlockGfxB:
	incbin	"src/data/r72a/BlockGfxB.bin"
	even

BlockGfxC:
	incbin	"src/data/r72a/BlockGfxC.bin"
	even

BlockGfxD:
	incbin	"src/data/r72a/BlockGfxD.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r72a/SpikeBallGfx.bin"
	even

HotaruGfx:
	incbin	"src/data/r72a/HotaruGfx.bin"
	even

KabasiraGfx:
	incbin	"src/data/r72a/KabasiraGfx.bin"
