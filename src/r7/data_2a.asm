...
Padding1:
	if REGION=USA
		...
		incbin	"Level/Palmtree Panic/Data/Padding/1 (Act 1 Present Demo, JE).bin", $14C, $76
	endif
...
StageCollision:
	incbin	"maps/r72a/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r72a/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r72a/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r72a/blocks.nem"
	even

StageGfx:
	incbin	"maps/r72a/gfx.nem"
	even
...
Padding3:
	if REGION=USA
		...
		incbin	"../padding/r72a_e_3.bin",0,$225C
	endif
