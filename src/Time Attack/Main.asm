...
; Time attack main CPU program (USA)
; -------------------------------------------------------------------------
...
L_FF5236:
	...
	dc.l	$FE193C2D,$FD8B423C,$210AE351,$B3DF62D0,$84215C6A,$3704D125,$49344E4E,$7362156A,$956A9084,$215C6A36,$215C7DF0,$842B8D46,$C0008041,$80040614,$08251235,$18451956
