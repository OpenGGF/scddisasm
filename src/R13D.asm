...
; ------------------------------------------------------------------------------
	...
	include "src/r1/scroll_3d.asm"
	include "src/r1/stage_draw_3d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r1/stage_data_load_3d.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r1/object_index_3.asm"
	...
	include "src/r1/debug_objects_3.asm"
	include "src/common/object_spawn.asm"
	include "src/r1/stage_object_maps_3.asm"
	...
	include "src/r1/stage_gfx_animate_3d.asm"
	include "src/r1/gfx_lists_3d.asm"
	include "src/r1/data_3d.asm"
