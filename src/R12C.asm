...
; ------------------------------------------------------------------------------
	...
	include "src/r1/scroll_2c.asm"
	include "src/r1/stage_draw_2c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r1/stage_data_load_2c.asm"
	...
	include "src/r1/debug_objects_2c.asm"
	...
	include "src/r1/collapse_data_2c.asm"
	include "src/objects/r1/platform.asm"
	include "src/objects/r1/v_door.asm"
	include "src/r1/section_gfx_2c.asm"
	...
	include "src/r1/stage_gfx_animate_2c.asm"
	include "src/r1/gfx_lists_2c.asm"
	include "src/r1/data_2c.asm"
