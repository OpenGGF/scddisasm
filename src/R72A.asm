...
; ------------------------------------------------------------------------------
	...
	include "src/r7/palette_cycle_a.asm"
	...
	include "src/r7/scroll_2a.asm"
	include "src/r7/stage_draw_2a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r7/stage_data_load_2a.asm"
	...
	include "src/r7/section_gfx_2a.asm"
	...
	include "src/r7/stage_gfx_animate_2a.asm"
	include "src/r7/gfx_lists_2a.asm"
	include "src/r7/data_2a.asm"
