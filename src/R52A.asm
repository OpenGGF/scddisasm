...
; ------------------------------------------------------------------------------
	...
	include "src/r5/palette_cycle_a.asm"
	...
	include "src/r5/background_swap_2a.asm"
	include "src/r5/scroll_2a.asm"
	include "src/r5/stage_draw_2a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r5/stage_data_load_2a.asm"
	...
	include "src/r5/stage_object_maps_2.asm"
	...
	include "src/r5/section_gfx_2a.asm"
	...
	include "src/r5/stage_gfx_animate_2a.asm"
	include "src/r5/gfx_lists_2a.asm"
	include "src/r5/data_2a.asm"
