...
; ------------------------------------------------------------------------------
	...
	include "src/r3/scroll_3d.asm"
	include "src/r3/stage_draw_3d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r3/stage_data_load_3d.asm"
	...
	include "src/r3/section_gfx_3d.asm"
	...
	include "src/r3/stage_gfx_animate_3d.asm"
	include "src/r3/gfx_lists_3d.asm"
	include "src/r3/data_3d.asm"
