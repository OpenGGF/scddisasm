...
; ------------------------------------------------------------------------------
	...
	include "src/r4/palette_cycle_a.asm"
	...
	include "src/r4/scroll_1a.asm"
	include "src/r4/stage_draw_1a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r4/stage_data_load_1a.asm"
	include "src/r4/events.asm"
	include "src/common/object.asm"
	include "src/r4/object_index_1a.asm"
	...
	include "src/r4/debug_objects_1a.asm"
	...
	include "src/sprites/title_card_r4.asm"
	include "src/r4/water_currents_1a.asm"
	include "src/r4/section_gfx_1a.asm"
	include "src/objects/r4/spikes.asm"
	include "src/objects/r4/h_move_block.asm"
	include "src/objects/r4/elevator.asm"
	include "src/objects/r4/switch.asm"
	include "src/objects/r4/door.asm"
	include "src/objects/r4/swing.asm"
	include "src/objects/r4/geyser.asm"
	...
	include "src/objects/r4/switch_elevator.asm"
	include "src/objects/r4/fall_spikes.asm"
	...
	include "src/r4/stage_gfx_animate_1a.asm"
	include "src/r4/gfx_lists_1a.asm"
	include "src/r4/data_1a.asm"
