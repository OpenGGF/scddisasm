...
; ------------------------------------------------------------------------------
	...
	include "src/r4/scroll_2b.asm"
	include "src/r4/stage_draw_2b.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r4/stage_data_load_2b.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r4/object_index_2b.asm"
	...
	include "src/r4/debug_objects_2b.asm"
	...
	include "src/r4/water_currents_2b.asm"
	include "src/r4/section_gfx_2b.asm"
	...
	include "src/r4/stage_gfx_animate_2b.asm"
	include "src/r4/gfx_lists_2b.asm"
	include "src/r4/data_2b.asm"
