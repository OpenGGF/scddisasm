...
; ------------------------------------------------------------------------------
	...
	include "src/r7/palette_cycle_c.asm"
	...
	include "src/r7/scroll_3c.asm"
	include "src/r7/stage_draw_3c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r7/stage_data_load_3c.asm"
	...
	include "src/r7/stage_gfx_animate_3c.asm"
	include "src/r7/gfx_lists_3c.asm"
	include "src/r7/data_3c.asm"
