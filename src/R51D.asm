...
; ------------------------------------------------------------------------------
	...
	include "src/r5/background_swap_1d.asm"
	include "src/r5/scroll_1d.asm"
	include "src/r5/stage_draw_1d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r5/stage_data_load_1d.asm"
	...
	include "src/r5/section_gfx_1d.asm"
	...
	include "src/r5/stage_gfx_animate_1d.asm"
	include "src/r5/gfx_lists_1d.asm"
	include "src/r5/data_1d.asm"
