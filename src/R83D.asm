...
; ------------------------------------------------------------------------------
	...
	include "src/r8/scroll_3d.asm"
	include "src/r8/stage_draw_3d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r8/stage_data_load_3d.asm"
	include "src/r8/events.asm"
	include "src/common/object.asm"
	include "src/r8/object_index_3.asm"
	...
	include "src/r8/debug_objects_3.asm"
	include "src/common/object_spawn.asm"
	include "src/r8/stage_object_maps_3.asm"
	...
	include "src/r8/section_gfx_3.asm"
	include "src/objects/r8/trap_3.asm"
	...
	include "src/objects/r8/spin_platform_3.asm"
	...
	include "src/r8/stage_gfx_animate_3d.asm"
	include "src/r8/gfx_lists_3d.asm"
	include "src/r8/data_3d.asm"
