...
; ------------------------------------------------------------------------------
	...
	include "src/r3/palette_cycle_b.asm"
	...
	include "src/r3/scroll_1b.asm"
	include "src/r3/stage_draw_1b.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r3/stage_data_load_1b.asm"
	...
	include "src/r3/debug_objects_1b.asm"
	...
	include "src/r3/section_gfx_1b.asm"
	...
	include "src/r3/stage_gfx_animate_1b.asm"
	include "src/r3/gfx_lists_1b.asm"
	include "src/r3/data_1b.asm"
