...
; ------------------------------------------------------------------------------
	...
	include "src/r7/palette_cycle_d.asm"
	...
	include "src/r7/scroll_3d.asm"
	include "src/r7/stage_draw_3d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r7/stage_data_load_3d.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r7/object_index_3.asm"
	...
	include "src/r7/debug_objects_3.asm"
	include "src/common/object_spawn.asm"
	include "src/r7/stage_object_maps_3.asm"
	...
	include "src/objects/r7/spring_launcher.asm"
	include "src/objects/r7/booster.asm"
	...
	include "src/r7/section_gfx_3c.asm"
	include "src/objects/r7/swing.asm"
	include "src/objects/r7/boss.asm"
	include "src/objects/r7/lamp.asm"
	...
	include "src/objects/r7/boss_block.asm"
	include "src/objects/r7/spikes.asm"
	include "src/objects/r7/amy_rose.asm"
	include "src/objects/r7/swap_platform.asm"
	include "src/r7/stage_gfx_animate_3d.asm"
	include "src/r7/gfx_lists_3d.asm"
	include "src/r7/data_3d.asm"
