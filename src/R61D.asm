...
; ------------------------------------------------------------------------------
	...
	include "src/r6/scroll_1d.asm"
	include "src/r6/stage_draw_1d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r6/stage_data_load_1d.asm"
	...
	include "src/r6/section_gfx_1d.asm"
	...
	include "src/r6/stage_gfx_animate_1d.asm"
	include "src/r6/gfx_lists_1d.asm"
	include "src/r6/data_1d.asm"
