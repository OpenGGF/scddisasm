...
; ------------------------------------------------------------------------------
	...
	include "src/r5/palette_cycle_c.asm"
	...
	include "src/r5/background_swap_1c.asm"
	include "src/r5/scroll_1c.asm"
	include "src/r5/stage_draw_1c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r5/stage_data_load_1c.asm"
	...
	include "src/r5/section_gfx_1c.asm"
	...
	include "src/r5/stage_gfx_animate_1c.asm"
	include "src/r5/gfx_lists_1c.asm"
	include "src/r5/data_1c.asm"
