...
; ------------------------------------------------------------------------------
	...
	include "src/r6/scroll_2c.asm"
	include "src/r6/stage_draw_2c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r6/stage_data_load_2c.asm"
	...
	include "src/r6/debug_objects_2c.asm"
	...
	include "src/r6/section_gfx_2c.asm"
	...
	include "src/r6/stage_gfx_animate_2c.asm"
	include "src/r6/gfx_lists_2c.asm"
	include "src/r6/data_2c.asm"
