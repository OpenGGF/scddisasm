...
; ------------------------------------------------------------------------------
	...
	include "src/r7/scroll_2c.asm"
	include "src/r7/stage_draw_2c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r7/stage_data_load_2c.asm"
	...
	include "src/r7/stage_object_maps_2.asm"
	...
	include "src/r7/section_gfx_2c.asm"
	...
	include "src/r7/stage_gfx_animate_2c.asm"
	include "src/r7/gfx_lists_2c.asm"
	include "src/r7/data_2c.asm"
