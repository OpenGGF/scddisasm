...
L_NonUSA_FF2ADC:
	andi.w	#$1FF, d0
L_NonUSA_FF2AE0:
	bne.b	L_NonUSA_FF2AE4
L_NonUSA_FF2AE2:
	addq.w	#$1, d0
L_NonUSA_FF2AE4:
	move.w	d0, (a2)+
L_NonUSA_FF2AE6:
	dbra	d1, L_NonUSA_FF2A98
L_NonUSA_FF2AEA:
	rts
L_NonUSA_FF2AEC:
	move.w	$8(a0), d0
L_NonUSA_FF2AF0:
	sub.w	$FFFFC400.w, d0
L_NonUSA_FF2AF4:
	bmi.b	L_NonUSA_FF2B10
L_NonUSA_FF2AF6:
	cmpi.w	#$140, d0
L_NonUSA_FF2AFA:
	bge.b	L_NonUSA_FF2B10
L_NonUSA_FF2AFC:
	move.w	$C(a0), d1
L_NonUSA_FF2B00:
	sub.w	$FFFFC404.w, d1
...
L_NonUSA_FF2B4A:
	move.b	$200020.l, d0
L_NonUSA_FF2B50:
	beq.b	L_NonUSA_FF2B92
L_NonUSA_FF2B52:
	subq.w	#$1, d0
L_NonUSA_FF2B54:
	cmpi.w	#$9, d0
L_NonUSA_FF2B58:
	bcc.b	L_NonUSA_FF2B78
L_NonUSA_FF2B5A:
	add.w	d0, d0
L_NonUSA_FF2B5C:
	lea.l	$FF2B94.l, a0
...
L_NonUSA_FF2B68:
	jsr	(a0, d0.w)
L_NonUSA_FF2B6C:
	bcs.b	L_NonUSA_FF2B78
L_NonUSA_FF2B6E:
	move.b	#$0, $200021.l
L_NonUSA_FF2B76:
	bra.b	L_NonUSA_FF2B80
L_NonUSA_FF2B78:
	move.b	#$FF, $200021.l
L_NonUSA_FF2B80:
	move.w	d0, $200022.l
...
L_NonUSA_FF3E6C:
	lea.l	$FF3E82.l, a0
L_NonUSA_FF3E72:
	bsr.w	L_NonUSA_FF3C78
L_NonUSA_FF3E76:
	move.b	#$8, $200020.l
L_NonUSA_FF3E7E:
	bra.w	L_NonUSA_FF3C90
L_NonUSA_FF3E82:
	dc.l	$2A2A2A2A
	dc.l	$2A2A2A2A
	dc.l	$2A2A2A00
...
L_NonUSA_FF3FF4:
	movem.l	(a7)+, d0
L_NonUSA_FF3FF8:
	dbra	d0, L_NonUSA_FF3FE6
L_NonUSA_FF3FFC:
	addq.l	#$8, a7
L_NonUSA_FF3FFE:
	bra.w	L_NonUSA_FF208E
L_NonUSA_FF4002:
	addq.l	#$8, a7
L_NonUSA_FF4004:
	bra.w	L_NonUSA_FF202E
...
L_NonUSA_FF408A:
	cmpi.b	#$1, d0
L_NonUSA_FF408E:
	beq.b	L_NonUSA_FF4098
L_NonUSA_FF4090:
	cmpi.b	#$2, d0
L_NonUSA_FF4094:
	beq.b	L_NonUSA_FF409C
L_NonUSA_FF4096:
	rts
L_NonUSA_FF4098:
	bra.w	L_NonUSA_FF3FE4
L_NonUSA_FF409C:
	move.b	#$2, $FFFFCD16.w
L_NonUSA_FF40A2:
	move.b	#$FF, $FFFFCD21.w
...
L_NonUSA_FF40BA:
	cmpi.b	#$6, $FFFFCD16.w
L_NonUSA_FF40C0:
	bne.b	L_NonUSA_FF40E8
L_NonUSA_FF40C2:
	bsr.w	L_NonUSA_FF3BF2
L_NonUSA_FF40C6:
	bne.b	L_NonUSA_FF40E8
L_NonUSA_FF40C8:
	bsr.w	$FF4F2A
...
L_NonUSA_FF40D4:
	bsr.w	$FF5134
L_NonUSA_FF40D8:
	beq.b	L_NonUSA_FF40E8
L_NonUSA_FF40DA:
	move.b	#$4, $FFFFCD1E.w
L_NonUSA_FF40E0:
	lea.l	$FF4D60.l, a0
L_NonUSA_FF40E6:
	bra.b	L_NonUSA_FF40EE
L_NonUSA_FF40E8:
	lea.l	$FF4D66.l, a0
L_NonUSA_FF40EE:
	bsr.w	$FF4C90
...
L_NonUSA_FF40F6:
	bsr.w	$FF4F4A
L_NonUSA_FF40FA:
	bgt.b	L_NonUSA_FF4100
L_NonUSA_FF40FC:
	bmi.b	L_NonUSA_FF413C
L_NonUSA_FF40FE:
	rts
L_NonUSA_FF4100:
	cmpi.b	#$3, $FFFFCD1E.w
L_NonUSA_FF4106:
	beq.b	L_NonUSA_FF411E
L_NonUSA_FF4108:
	cmpi.b	#$1, $FFFFCD1E.w
L_NonUSA_FF410E:
	beq.b	L_NonUSA_FF412C
L_NonUSA_FF4110:
	move.b	#$28, $FFFFCD23.w
L_NonUSA_FF4116:
	move.w	#$4, $FFFFCD14.w
...
L_NonUSA_FF4140:
	cmpi.b	#$2, $FFFFCD16.w
L_NonUSA_FF4146:
	beq.b	L_NonUSA_FF4156
L_NonUSA_FF4148:
	move.w	#$1, $FFFFCD14.w
L_NonUSA_FF414E:
	move.b	$FFFFCD16.w, $FFFFCD1E.w
L_NonUSA_FF4154:
	bra.b	L_NonUSA_FF4162
L_NonUSA_FF4156:
	move.w	#$0, $FFFFCD14.w
L_NonUSA_FF415C:
	move.b	$FFFFCD16.w, $FFFFCD1E.w
...
L_NonUSA_FF418A:
	bsr.w	$FF4DE6
L_NonUSA_FF418E:
	bra.b	L_NonUSA_FF4208
L_NonUSA_FF4190:
	btst	#$1, d0
L_NonUSA_FF4194:
	beq.b	L_NonUSA_FF41A6
L_NonUSA_FF4196:
	move.w	#$9B, d0
L_NonUSA_FF419A:
	jsr	$FF25B8.l
...
L_NonUSA_FF41A6:
	btst	#$2, d0
L_NonUSA_FF41AA:
	beq.b	L_NonUSA_FF41B4
L_NonUSA_FF41AC:
	tst.b	$FFFFCD25.w
L_NonUSA_FF41B0:
	bne.b	L_NonUSA_FF420A
L_NonUSA_FF41B2:
	bra.b	L_NonUSA_FF4208
L_NonUSA_FF41B4:
	btst	#$3, d0
L_NonUSA_FF41B8:
	beq.b	L_NonUSA_FF41C2
L_NonUSA_FF41BA:
	tst.b	$FFFFCD24.w
L_NonUSA_FF41BE:
	bne.b	L_NonUSA_FF420A
...
L_NonUSA_FF41C2:
	bsr.w	$FF4F4A
L_NonUSA_FF41C6:
	beq.b	L_NonUSA_FF4208
L_NonUSA_FF41C8:
	bmi.b	L_NonUSA_FF4208
L_NonUSA_FF41CA:
	bsr.w	$FF4F2A
L_NonUSA_FF41CE:
	move.w	$10(a1), d0
...
L_NonUSA_FF41DC:
	cmp.w	$8(a1), d0
L_NonUSA_FF41E0:
	bge.b	L_NonUSA_FF4208
L_NonUSA_FF41E2:
	tst.b	$FFFFCD24.w
L_NonUSA_FF41E6:
	beq.b	L_NonUSA_FF41F0
L_NonUSA_FF41E8:
	move.b	#$FF, $FFFFCD24.w
L_NonUSA_FF41EE:
	bra.b	L_NonUSA_FF41F6
L_NonUSA_FF41F0:
	move.b	#$FF, $FFFFCD25.w
L_NonUSA_FF41F6:
	bsr.w	$FF5014
...
L_NonUSA_FF4232:
	cmpi.b	#$6, $FFFFCD16.w
L_NonUSA_FF4238:
	beq.b	L_NonUSA_FF424C
L_NonUSA_FF423A:
	cmpi.b	#$5, $FFFFCD16.w
L_NonUSA_FF4240:
	beq.b	L_NonUSA_FF4256
L_NonUSA_FF4242:
	move.b	d0, $FFFFCD25.w
L_NonUSA_FF4246:
	move.b	d0, $FFFFCD24.w
L_NonUSA_FF424A:
	bra.b	$FF42AC
L_NonUSA_FF424C:
	move.b	d0, $FFFFCD21.w
L_NonUSA_FF4250:
	move.b	d0, $FFFFCD24.w
L_NonUSA_FF4254:
	bra.b	$FF42AC
...
L_NonUSA_FF42B0:
	cmpi.b	#$1, d0
L_NonUSA_FF42B4:
	beq.b	L_NonUSA_FF42D6
L_NonUSA_FF42B6:
	cmpi.b	#$2, d0
L_NonUSA_FF42BA:
	beq.b	L_NonUSA_FF42DE
L_NonUSA_FF42BC:
	cmpi.b	#$3, d0
L_NonUSA_FF42C0:
	beq.b	L_NonUSA_FF42E6
L_NonUSA_FF42C2:
	cmpi.b	#$4, d0
L_NonUSA_FF42C6:
	beq.b	L_NonUSA_FF42EE
L_NonUSA_FF42C8:
	cmpi.b	#$5, d0
L_NonUSA_FF42CC:
	beq.b	L_NonUSA_FF42F6
L_NonUSA_FF42CE:
	cmpi.b	#$6, d0
L_NonUSA_FF42D2:
	beq.b	L_NonUSA_FF42FE
L_NonUSA_FF42D4:
	rts
L_NonUSA_FF42D6:
	move.b	#$1, $FFFFCD20.w
...
L_NonUSA_FF430C:
	add.w	d0, d0
L_NonUSA_FF430E:
	move.w	L_NonUSA_FF4316(pc, d0.w), d0
L_NonUSA_FF4312:
	jmp	L_NonUSA_FF4316(pc, d0.w)
L_NonUSA_FF4316:
	dc.w	$0018,$00CC,$013E,$0152,$017E,$0218
	dc.w	$02D8,$02F8,$034C,$0370,$0392,$03B4
L_NonUSA_FF432E:
	bsr.w	$FF5716
L_NonUSA_FF4332:
	cmpi.b	#$2, $FFFFCD16.w
L_NonUSA_FF4338:
	beq.w	L_NonUSA_FF43B6
L_NonUSA_FF433C:
	bsr.w	$FF4F2A
L_NonUSA_FF4340:
	move.w	$6(a1), d0
...
L_NonUSA_FF4348:
	bsr.w	$FF5134
L_NonUSA_FF434C:
	beq.b	L_NonUSA_FF439A
L_NonUSA_FF434E:
	cmpi.b	#$5, $FFFFCD16.w
L_NonUSA_FF4354:
	beq.b	L_NonUSA_FF4364
L_NonUSA_FF4356:
	move.b	#$5, $FFFFCD1E.w
L_NonUSA_FF435C:
	move.b	#$5, $FFFFCD17.w
L_NonUSA_FF4362:
	bra.b	L_NonUSA_FF4370
L_NonUSA_FF4364:
	move.b	#$6, $FFFFCD1E.w
L_NonUSA_FF436A:
	move.b	#$6, $FFFFCD17.w
...
L_NonUSA_FF43FC:
	bsr.w	$FF4F4A
L_NonUSA_FF4400:
	bgt.b	L_NonUSA_FF4408
L_NonUSA_FF4402:
	bmi.w	L_NonUSA_FF443E
L_NonUSA_FF4406:
	rts
L_NonUSA_FF4408:
	bsr.w	$FF4C86
L_NonUSA_FF440C:
	cmpi.b	#$5, $FFFFCD1E.w
L_NonUSA_FF4412:
	beq.b	L_NonUSA_FF441C
L_NonUSA_FF4414:
	move.b	#$28, $FFFFCD25.w
L_NonUSA_FF441A:
	bra.b	L_NonUSA_FF4422
L_NonUSA_FF441C:
	move.b	#$28, $FFFFCD24.w
L_NonUSA_FF4422:
	move.b	$FFFFCD1E.w, $FFFFCD17.w
L_NonUSA_FF4428:
	bsr.w	$FF4DA6
L_NonUSA_FF442C:
	move.b	#$4, $FFFFB3A4.w
...
L_NonUSA_FF452E:
	bsr.w	$FF3BF2
L_NonUSA_FF4532:
	beq.b	L_NonUSA_FF4570
L_NonUSA_FF4534:
	lea.l	$FF4D84.l, a0
L_NonUSA_FF453A:
	cmpi.b	#$6, $FFFFCD16.w
L_NonUSA_FF4540:
	beq.b	L_NonUSA_FF4548
L_NonUSA_FF4542:
	lea.l	$FF4D7A.l, a0
L_NonUSA_FF4548:
	bsr.w	$FF4C90
...
L_NonUSA_FF4550:
	bsr.w	$FF4F4A
L_NonUSA_FF4554:
	bgt.b	L_NonUSA_FF457A
L_NonUSA_FF4556:
	bmi.b	L_NonUSA_FF455A
L_NonUSA_FF4558:
	rts
L_NonUSA_FF455A:
	bsr.w	$FF4C86
...
L_NonUSA_FF45EC:
	rts
L_NonUSA_FF45EE:
	cmpi.b	#$10, $FFFFB3A4.w
L_NonUSA_FF45F4:
	beq.b	L_NonUSA_FF45F8
L_NonUSA_FF45F6:
	rts
L_NonUSA_FF45F8:
	move.b	#$7, $FFFFCD14.w
...
L_NonUSA_FF4738:
	add.w	d0, d0
L_NonUSA_FF473A:
	move.w	L_NonUSA_FF4742(pc, d0.w), d0
L_NonUSA_FF473E:
	jmp	L_NonUSA_FF4742(pc, d0.w)
L_NonUSA_FF4742:
	dc.w	$001A,$0048,$0060,$0072,$00EE,$0000,$0000,$0000
	dc.w	$0116,$012E,$0140,$016E,$0196
L_NonUSA_FF475C:
	tst.b	$FFFFCD21.w
L_NonUSA_FF4760:
	bne.b	L_NonUSA_FF477C
L_NonUSA_FF4762:
	move.b	#$1, $FFFFCD14.w
L_NonUSA_FF4768:
	bsr.w	$FF495A
...
L_NonUSA_FF47B4:
	tst.b	$FFFFCD2B.w
L_NonUSA_FF47B8:
	beq.b	L_NonUSA_FF481E
L_NonUSA_FF47BA:
	bsr.w	$FF492A
L_NonUSA_FF47BE:
	tst.b	$FF0F1F.l
L_NonUSA_FF47C4:
	beq.w	L_NonUSA_FF480C
L_NonUSA_FF47C8:
	bsr.w	$FF3C54
L_NonUSA_FF47CC:
	bsr.w	$FF4F2A
...
L_NonUSA_FF4AD0:
	btst	#$2, d0
L_NonUSA_FF4AD4:
	beq.b	L_NonUSA_FF4ADC
L_NonUSA_FF4AD6:
	subq.b	#$1, d1
L_NonUSA_FF4AD8:
	bge.b	L_NonUSA_FF4ADC
L_NonUSA_FF4ADA:
	clr.b	d1
L_NonUSA_FF4ADC:
	btst	#$3, d0
L_NonUSA_FF4AE0:
	beq.b	L_NonUSA_FF4AEE
L_NonUSA_FF4AE2:
	addq.b	#$1, d1
L_NonUSA_FF4AE4:
	cmpi.b	#$1, d1
L_NonUSA_FF4AE8:
	ble.b	L_NonUSA_FF4AEE
L_NonUSA_FF4AEA:
	move.b	#$1, d1
L_NonUSA_FF4AEE:
	move.b	d1, $FFFFCD40.w
...
L_NonUSA_FF4AFE:
	btst	#$1, d0
L_NonUSA_FF4B02:
	beq.b	L_NonUSA_FF4B10
L_NonUSA_FF4B04:
	subq.b	#$1, d1
L_NonUSA_FF4B06:
	cmpi.b	#$30, d1
L_NonUSA_FF4B0A:
	bge.b	L_NonUSA_FF4B10
L_NonUSA_FF4B0C:
	move.b	#$39, d1
L_NonUSA_FF4B10:
	btst	#$0, d0
L_NonUSA_FF4B14:
	beq.b	L_NonUSA_FF4B22
L_NonUSA_FF4B16:
	addq.b	#$1, d1
L_NonUSA_FF4B18:
	cmpi.b	#$39, d1
L_NonUSA_FF4B1C:
	ble.b	L_NonUSA_FF4B22
L_NonUSA_FF4B1E:
	move.b	#$30, d1
L_NonUSA_FF4B22:
	move.b	d1, (a0)
...
L_NonUSA_FF4BB0:
	btst	#$2, d0
L_NonUSA_FF4BB4:
	beq.b	L_NonUSA_FF4BDC
L_NonUSA_FF4BB6:
	cmpi.b	#$1, $FFFFCD2A.w
L_NonUSA_FF4BBC:
	beq.b	L_NonUSA_FF4BCE
L_NonUSA_FF4BBE:
	move.w	#$9B, d0
L_NonUSA_FF4BC2:
	jsr	$FF25B8.l
...
L_NonUSA_FF4BDC:
	btst	#$3, d0
L_NonUSA_FF4BE0:
	beq.b	L_NonUSA_FF4C12
L_NonUSA_FF4BE2:
	cmpi.b	#$0, $FFFFCD2A.w
L_NonUSA_FF4BE8:
	beq.b	L_NonUSA_FF4BFA
L_NonUSA_FF4BEA:
	move.w	#$9B, d0
L_NonUSA_FF4BEE:
	jsr	$FF25B8.l
...
L_NonUSA_FF4C14:
	tst.b	$FFFFCD2A.w
L_NonUSA_FF4C18:
	beq.b	L_NonUSA_FF4C22
L_NonUSA_FF4C1A:
	move.b	#$1, $FFFFCD2B.w
L_NonUSA_FF4C20:
	bra.b	L_NonUSA_FF4C2C
L_NonUSA_FF4C22:
	move.b	#$0, $FFFFCD2B.w
L_NonUSA_FF4C28:
	bra.b	L_NonUSA_FF4C2C
...
L_NonUSA_FF4C96:
	andi.b	#$F, d1
L_NonUSA_FF4C9A:
	beq.w	L_NonUSA_FF4CD2
L_NonUSA_FF4C9E:
	bsr.w	$FF4D40
L_NonUSA_FF4CA2:
	btst	#$0, d1
L_NonUSA_FF4CA6:
	beq.b	L_NonUSA_FF4CAE
L_NonUSA_FF4CA8:
	move.b	$1(a0), d0
L_NonUSA_FF4CAC:
	bne.b	L_NonUSA_FF4CD4
L_NonUSA_FF4CAE:
	btst	#$1, d1
L_NonUSA_FF4CB2:
	beq.b	L_NonUSA_FF4CBA
L_NonUSA_FF4CB4:
	move.b	$2(a0), d0
L_NonUSA_FF4CB8:
	bne.b	L_NonUSA_FF4CD4
...
L_NonUSA_FF4D44:
	cmp.b	(a0), d0
L_NonUSA_FF4D46:
	beq.b	L_NonUSA_FF4D4E
L_NonUSA_FF4D48:
	adda.w	#$5, a0
L_NonUSA_FF4D4C:
	bra.b	L_NonUSA_FF4D44
L_NonUSA_FF4D4E:
	rts
L_NonUSA_FF4D50:
	dc.b	$01,$00,$00,$05,$06,$00
...
L_NonUSA_FF4DEE:
	tst.w	$2(a1)
L_NonUSA_FF4DF2:
	beq.w	L_NonUSA_FF4E6E
L_NonUSA_FF4DF6:
	cmpi.w	#$1, $2(a1)
L_NonUSA_FF4DFC:
	bne.w	L_NonUSA_FF4E08
L_NonUSA_FF4E00:
	tst.w	$10(a1)
L_NonUSA_FF4E04:
	beq.w	L_NonUSA_FF4E6E
...
L_NonUSA_FF4E0E:
	cmp.w	$10(a1), d0
L_NonUSA_FF4E12:
	bne.b	L_NonUSA_FF4E16
L_NonUSA_FF4E14:
	subq.w	#$1, d0
L_NonUSA_FF4E16:
	tst.w	d0
L_NonUSA_FF4E18:
	bge.w	L_NonUSA_FF4E4A
L_NonUSA_FF4E1C:
	tst.w	$12(a1)
L_NonUSA_FF4E20:
	beq.w	L_NonUSA_FF4E6E
...
L_NonUSA_FF4E7E:
	tst.w	$2(a1)
L_NonUSA_FF4E82:
	beq.w	L_NonUSA_FF4F22
L_NonUSA_FF4E86:
	cmpi.w	#$1, $2(a1)
L_NonUSA_FF4E8C:
	bne.w	L_NonUSA_FF4E98
L_NonUSA_FF4E90:
	tst.w	$10(a1)
L_NonUSA_FF4E94:
	beq.w	L_NonUSA_FF4F22
...
L_NonUSA_FF4E9E:
	cmp.w	$10(a1), d0
L_NonUSA_FF4EA2:
	bne.b	L_NonUSA_FF4EA6
L_NonUSA_FF4EA4:
	addq.w	#$1, d0
L_NonUSA_FF4EA6:
	cmp.w	$8(a1), d0
L_NonUSA_FF4EAA:
	bge.w	L_NonUSA_FF4F22
L_NonUSA_FF4EAE:
	cmpi.w	#$FE, d0
L_NonUSA_FF4EB2:
	blt.w	L_NonUSA_FF4EF6
L_NonUSA_FF4EB6:
	move.w	$12(a1), d1
L_NonUSA_FF4EBA:
	addq.w	#$1, d1
...
L_NonUSA_FF4EDA:
	cmpi.w	#$0, $10(a1)
L_NonUSA_FF4EE0:
	bne.b	L_NonUSA_FF4EE6
L_NonUSA_FF4EE2:
	addq.w	#$1, $6(a1)
L_NonUSA_FF4EE6:
	move.w	$6(a1), d0
L_NonUSA_FF4EEA:
	bra.w	L_NonUSA_FF4EF6
L_NonUSA_FF4EEE:
	cmp.w	$8(a1), d0
L_NonUSA_FF4EF2:
	bge.w	L_NonUSA_FF4F22
...
L_NonUSA_FF4F4E:
	cmpi.b	#$3, $FFFFCD1F.w
L_NonUSA_FF4F54:
	beq.b	L_NonUSA_FF4F78
L_NonUSA_FF4F56:
	tst.b	$FFFFCD1F.w
L_NonUSA_FF4F5A:
	bne.b	L_NonUSA_FF4F74
L_NonUSA_FF4F5C:
	move.b	$A1201F.l, d0
L_NonUSA_FF4F62:
	andi.b	#$60, d0
L_NonUSA_FF4F66:
	bne.b	L_NonUSA_FF4F80
L_NonUSA_FF4F68:
	move.b	$A1201F.l, d0
L_NonUSA_FF4F6E:
	andi.b	#$10, d0
L_NonUSA_FF4F72:
	bne.b	L_NonUSA_FF4FA6
L_NonUSA_FF4F74:
	moveq	#$0, d0
L_NonUSA_FF4F76:
	bra.b	L_NonUSA_FF4FB2
L_NonUSA_FF4F78:
	clr.b	$FFFFCD1F.w
L_NonUSA_FF4F7C:
	moveq	#$1, d0
...
L_NonUSA_FF50B8:
	cmp.b	$FFFFCD40.w, d2
L_NonUSA_FF50BC:
	beq.b	L_NonUSA_FF50C4
L_NonUSA_FF50BE:
	addi.w	#$4000, d0
L_NonUSA_FF50C2:
	bra.b	L_NonUSA_FF50C8
L_NonUSA_FF50C4:
	addi.w	#$0, d0
L_NonUSA_FF50C8:
	move.w	d0, (a1)
...
L_NonUSA_FF50E8:
	move.w	$4(a1), d0
L_NonUSA_FF50EC:
	bne.b	L_NonUSA_FF5104
L_NonUSA_FF50EE:
	cmpi.w	#$FFFF, $10(a1)
L_NonUSA_FF50F4:
	beq.b	L_NonUSA_FF50FE
L_NonUSA_FF50F6:
	cmpi.w	#$2, $2(a1)
L_NonUSA_FF50FC:
	blt.b	L_NonUSA_FF5106
L_NonUSA_FF50FE:
	tst.w	$2(a1)
L_NonUSA_FF5102:
	beq.b	L_NonUSA_FF5106
L_NonUSA_FF5104:
	addq.w	#$1, d0
L_NonUSA_FF5106:
	rts
...
L_NonUSA_FF5390:
	move.l	d1, (a2)+
L_NonUSA_FF5392:
	bra.b	L_NonUSA_FF5386
L_NonUSA_FF5394:
	bsr.w	$FF53A6
L_NonUSA_FF5398:
	tst.w	$10(a1)
L_NonUSA_FF539C:
	bne.b	L_NonUSA_FF53A4
L_NonUSA_FF539E:
	move.w	#$1, $6(a1)
L_NonUSA_FF53A4:
	rts
L_NonUSA_FF53A6:
	bsr.w	$FF3BEA
L_NonUSA_FF53AA:
	bne.w	L_NonUSA_FF53D6
L_NonUSA_FF53AE:
	bsr.w	$FF4F2A
L_NonUSA_FF53B2:
	tst.w	$8(a1)
L_NonUSA_FF53B6:
	beq.b	L_NonUSA_FF53D6
L_NonUSA_FF53B8:
	movea.l	a1, a0
L_NonUSA_FF53BA:
	adda.w	#$30, a0
...
L_NonUSA_FF53CC:
	cmp.w	$8(a1), d0
L_NonUSA_FF53D0:
	bge.w	L_NonUSA_FF53D6
L_NonUSA_FF53D4:
	bra.b	L_NonUSA_FF53C0
L_NonUSA_FF53D6:
	move.w	#$FFFF, $10(a1)
L_NonUSA_FF53DC:
	rts
...
L_NonUSA_FF5548:
	movem.l	(a7)+, d0-d7/a0-a6
L_NonUSA_FF554C:
	bra.b	L_NonUSA_FF5536
L_NonUSA_FF554E:
	move.l	d0, $C(a1)
L_NonUSA_FF5552:
	bpl.b	L_NonUSA_FF555A
L_NonUSA_FF5554:
	addi.w	#$100, $C(a1)
L_NonUSA_FF555A:
	bsr.w	$FF55B6
...
L_NonUSA_FF557E:
	tst.w	$10(a1)
L_NonUSA_FF5582:
	bmi.b	L_NonUSA_FF558C
L_NonUSA_FF5584:
	cmp.w	$10(a1), d1
L_NonUSA_FF5588:
	blt.b	L_NonUSA_FF558C
L_NonUSA_FF558A:
	addq.w	#$1, d1
L_NonUSA_FF558C:
	cmp.w	$8(a1), d1
L_NonUSA_FF5590:
	bge.b	L_NonUSA_FF55A0
L_NonUSA_FF5592:
	move.w	d1, d0
L_NonUSA_FF5594:
	bsr.w	$FF5650
...
L_NonUSA_FF5690:
	rts
L_NonUSA_FF5692:
	bsr.w	L_NonUSA_FF5716
L_NonUSA_FF5696:
	lea.l	$FFFFcd60.w, a0
L_NonUSA_FF569A:
	bsr.w	L_NonUSA_FF3C78
L_NonUSA_FF569E:
	bsr.w	L_NonUSA_FF3EB2
L_NonUSA_FF56A2:
	rts
L_NonUSA_FF56A4:
	bsr.w	L_NonUSA_FF5730
L_NonUSA_FF56A8:
	lea.l	$FFFFcd70.w, a0
L_NonUSA_FF56AC:
	bsr.w	L_NonUSA_FF3C78
L_NonUSA_FF56B0:
	bsr.w	L_NonUSA_FF3ED6
L_NonUSA_FF56B4:
	rts
L_NonUSA_FF56B6:
	bsr.w	L_NonUSA_FF5716
...
L_NonUSA_FF56BE:
	bsr.w	L_NonUSA_FF3C78
L_NonUSA_FF56C2:
	bsr.w	L_NonUSA_FF3EA0
L_NonUSA_FF56C6:
	bne.w	L_NonUSA_FF56F6
L_NonUSA_FF56CA:
	move.w	$200022.l, d0
L_NonUSA_FF56D0:
	move.w	d0, $20002a.l
...
L_NonUSA_FF571C:
	cmpi.b	#$5, $FFFFcd16.w
L_NonUSA_FF5722:
	beq.b	L_NonUSA_FF5726
L_NonUSA_FF5724:
	moveq	#$0, d0
L_NonUSA_FF5726:
	bsr.w	L_NonUSA_FF3BDA
L_NonUSA_FF572A:
	movem.l	(a7)+, d0
L_NonUSA_FF572E:
	rts
...
L_NonUSA_FF574C:
	move.b	$24(a0), d0
L_NonUSA_FF5750:
	move.w	L_NonUSA_FF576A(pc, d0.w), d0
L_NonUSA_FF5754:
	jsr	L_NonUSA_FF576A(pc, d0.w)
L_NonUSA_FF5758:
	lea.l	$FF5A48.l, a1
L_NonUSA_FF575E:
	jsr	$FF2760.l
...
L_NonUSA_FF5858:
	rts
L_NonUSA_FF585A:
	bsr.b	L_NonUSA_FF5828
L_NonUSA_FF585C:
	cmpi.b	#$1, $2D(a0)
L_NonUSA_FF5862:
	beq.b	L_NonUSA_FF58A6
L_NonUSA_FF5864:
	move.b	#$2, $2D(a0)
L_NonUSA_FF586A:
	beq.b	L_NonUSA_FF58D6
L_NonUSA_FF586C:
	move.w	#$400, $10(a0)
L_NonUSA_FF5872:
	clr.w	$12(a0)
...
L_NonUSA_FF587A:
	cmp.w	$32(a0), d0
L_NonUSA_FF587E:
	beq.b	L_NonUSA_FF58B6
L_NonUSA_FF5880:
	blt.b	L_NonUSA_FF5894
L_NonUSA_FF5882:
	bset.b	#$0, $22(a0)
L_NonUSA_FF5888:
	bset.b	#$0, $1(a0)
...
L_NonUSA_FF58C4:
	cmp.w	$34(a0), d0
L_NonUSA_FF58C8:
	beq.b	L_NonUSA_FF58E6
L_NonUSA_FF58CA:
	blt.b	L_NonUSA_FF58D0
L_NonUSA_FF58CC:
	neg.w	$12(a0)
L_NonUSA_FF58D0:
	move.b	#$2, $2D(a0)
...
L_NonUSA_FF5A40:
	...
	dc.w	$00DC,$00BC
L_NonUSA_FF5A48:
	dc.w	$000E,$0019,$001F,$0023,$0029,$002D,$0031
L_NonUSA_FF5A56:
	dc.w	$1700
L_NonUSA_FF5A58:
	dc.b	$00,$00,$00,$00,$00,$01,$02,$FE,$02,$07,$03,$04,$05,$04,$FF,$01
	dc.b	$06,$07,$FF,$01,$08,$09,$08,$0A,$FF,$13,$01,$02,$FF,$05,$0B,$0D
	dc.b	$FF,$01,$03,$03,$03,$04,$04,$04,$05,$05,$05,$04,$04,$04,$06,$07
	dc.b	$FE,$02
L_NonUSA_FF5A8A:
	dc.w	$001C,$0022,$0028,$002E,$0034,$003A,$0040
	dc.w	$0046,$004C,$0052,$0058,$005E,$0064,$006A
L_NonUSA_FF5AA6:
	dc.w	$01F4,$0600,$20F8
L_NonUSA_FF5AAC:
	dc.w	$01F4,$0600,$26F8
...
L_NonUSA_FF5AFC:
	move.b	$24(a0), d0
L_NonUSA_FF5B00:
	move.w	L_NonUSA_FF5B08(pc, d0.w), d0
L_NonUSA_FF5B04:
	jmp	L_NonUSA_FF5B08(pc, d0.w)
L_NonUSA_FF5B08:
	dc.w	$0006,$006C,$006C
L_NonUSA_FF5B0E:
	move.b	#$4, $1(a0)
...
L_NonUSA_FF5B74:
	jmp	$FF2834.l
L_NonUSA_FF5B7A:
	dc.w	$0004,$0010,$02F4,$0E00,$00E0,$F40E,$000C,$0000
	dc.w	$02F4,$0E00,$18E0,$F40E,$0024,$0000
L_NonUSA_FF5B96:
	moveq	#$0, d0
L_NonUSA_FF5B98:
	move.b	$24(a0), d0
...
L_NonUSA_FF5BD8:
	tst.b	$FFFFCD2C.w
L_NonUSA_FF5BDC:
	bne.b	L_NonUSA_FF5BE0
L_NonUSA_FF5BDE:
	rts
L_NonUSA_FF5BE0:
	cmpi.b	#$1, $FFFFCD29.w
L_NonUSA_FF5BE6:
	beq.b	L_NonUSA_FF5BF6
L_NonUSA_FF5BE8:
	move.w	#$18, $8(a0)
L_NonUSA_FF5BEE:
	move.w	#$A8, $C(a0)
L_NonUSA_FF5BF4:
	bra.b	L_NonUSA_FF5C02
L_NonUSA_FF5BF6:
	move.w	#$78, $8(a0)
L_NonUSA_FF5BFC:
	move.w	#$A8, $C(a0)
...
L_NonUSA_FF5C26:
	rts
L_NonUSA_FF5C28:
	dc.w	$0002,$1300,$0001,$FF00,$0004
L_NonUSA_FF5C32:
	dc.w	$0014,$0300,$0F00,$0000,$0003,$0010,$2000,$0E00,$1428,$0200
L_NonUSA_FF5C46:
	dc.w	$0F00,$0000,$0003,$0010,$2000
L_NonUSA_FF5C50:
	moveq	#$0, d0
L_NonUSA_FF5C52:
	move.b	$24(a0), d0
L_NonUSA_FF5C56:
	move.w	$FF5C5E(pc, d0.w), d0
L_NonUSA_FF5C5A:
	jmp	$FF5C5E(pc, d0.w)
L_NonUSA_FF5C5E:
	dc.w	$0012,$003E,$0040
L_NonUSA_FF5C64:
	dc.w	$012C,$016E,$019A,$01D6,$0212,$0260
L_NonUSA_FF5C70:
	move.b	#$4, $1(a0)
L_NonUSA_FF5C76:
	move.b	#$2, $24(a0)
...
L_NonUSA_FF5CB8:
	cmpi.b	#$2, $FFFFCD16.w
L_NonUSA_FF5CBE:
	beq.b	L_NonUSA_FF5CD0
L_NonUSA_FF5CC0:
	cmpi.b	#$6, $FFFFCD16.w
L_NonUSA_FF5CC6:
	beq.b	L_NonUSA_FF5CCA
L_NonUSA_FF5CC8:
	nop
L_NonUSA_FF5CCA:
	subi.w	#$10, $C(a0)
...
L_NonUSA_FF5EC6:
	move.b	$24(a0), d0
L_NonUSA_FF5ECA:
	move.w	L_NonUSA_FF5ED2(pc, d0.w), d0
L_NonUSA_FF5ECE:
	jmp	L_NonUSA_FF5ED2(pc, d0.w)
L_NonUSA_FF5ED2:
	dc.w	$0010,$003C,$0126,$0160,$017E,$0192,$01C8,$01EC
L_NonUSA_FF5EE2:
	move.b	#$4, $1(a0)
L_NonUSA_FF5EE8:
	move.b	#$2, $24(a0)
...
L_NonUSA_FF60D0:
	rts
L_NonUSA_FF60D2:
	dc.w	$0002,$01FC,$0000,$00FC
L_NonUSA_FF60DA:
	moveq	#$0, d0
L_NonUSA_FF60DC:
	move.b	$24(a0), d0
L_NonUSA_FF60E0:
	move.w	L_NonUSA_FF60E8(pc, d0.w), d0
L_NonUSA_FF60E4:
	jmp	L_NonUSA_FF60E8(pc, d0.w)
L_NonUSA_FF60E8:
	dc.w	$0008,$0040,$00B0,$00D0
L_NonUSA_FF60F0:
	move.b	#$4, $1(a0)
L_NonUSA_FF60F6:
	move.b	#$2, $24(a0)
...
L_NonUSA_FF6122:
	move.w	#$38, $C(a0)
L_NonUSA_FF6128:
	bsr.w	L_NonUSA_FF6188
L_NonUSA_FF612C:
	cmpi.b	#$1, $FFFFCD50.w
L_NonUSA_FF6132:
	beq.b	L_NonUSA_FF6168
L_NonUSA_FF6134:
	cmpi.b	#$2, $FFFFCD50.w
L_NonUSA_FF613A:
	beq.b	L_NonUSA_FF6178
L_NonUSA_FF613C:
	cmpi.b	#$3, $FFFFCD50.w
L_NonUSA_FF6142:
	beq.b	L_NonUSA_FF6146
L_NonUSA_FF6144:
	rts
L_NonUSA_FF6146:
	move.w	#$A0, $8(a0)
...
L_NonUSA_FF61A0:
	cmpi.w	#$EC, $C(a0)
L_NonUSA_FF61A6:
	bgt.b	L_NonUSA_FF61AC
L_NonUSA_FF61A8:
	bsr.b	L_NonUSA_FF6188
L_NonUSA_FF61AA:
	rts
L_NonUSA_FF61AC:
	addq.b	#$1, $FFFFCD51.w
...
L_NonUSA_FF621E:
	rts
L_NonUSA_FF6220:
	dc.w	$0008,$000E,$0014,$001A,$01F8,$0008,$02F8,$01F8
	dc.w	$0008,$0000,$0100,$0008,$03F8,$0100,$0008,$0100
L_NonUSA_FF6240:
	bsr.w	$FF6266
L_NonUSA_FF6244:
	move.w	$2E(a0), d0
...
L_NonUSA_FF62A0:
	ror.l	#$8, d0
L_NonUSA_FF62A2:
	dbra	d2, L_NonUSA_FF6288
L_NonUSA_FF62A6:
	rts
L_NonUSA_FF62A8:
	dc.l	$40200000,$00FF68C6
	dc.l	$44C00000,$00FF68BE
	dc.l	$44E00000,$00FF86C8
	dc.l	$45600000,$00FF807C
	dc.l	$4B600000,$00FF7808
	dc.l	$5B600000,$00FF8758
...
L_NonUSA_FF637E:
	moveq	#$8, d3
L_NonUSA_FF6380:
	dbra	d0, L_NonUSA_FF6372
L_NonUSA_FF6384:
	bra.b	L_NonUSA_FF633A
L_NonUSA_FF6386:
	subq.w	#$6, d6
L_NonUSA_FF6388:
	cmpi.w	#$9, d6
L_NonUSA_FF638C:
	bcc.b	L_NonUSA_FF6394
L_NonUSA_FF638E:
	addq.w	#$8, d6
L_NonUSA_FF6390:
	asl.w	#$8, d5
...
L_NonUSA_FF6472:
	if REGION=JAPAN
	dc.l	$00FF8CB0,$00FF8D50,$00FF8DF0,$00FF8E90,$00FF8F30,$00FF8FD0,$00FF9070
	dc.l	$00FF9110,$00FF91B0,$00FF9250,$00FF92F0,$00FF9390,$00FF9430,$00FF94D0
	else
	dc.l	$00FF8CE2,$00FF8D82,$00FF8E22,$00FF8EC2,$00FF8F62,$00FF9002,$00FF90A2
	dc.l	$00FF9142,$00FF91E2,$00FF9282,$00FF9322,$00FF93C2,$00FF9462,$00FF9502
	endif
L_NonUSA_FF64AA:
	move.w	d0, -(a7)
L_NonUSA_FF64AC:
...
L_NonUSA_FF64F2:
	move.w	(a0)+, (a1)
L_NonUSA_FF64F4:
	dbra	d1, L_NonUSA_FF64F2
L_NonUSA_FF64F8:
	addi.l	#$800000, d0
L_NonUSA_FF64FE:
	dbra	d2, L_NonUSA_FF64EA
L_NonUSA_FF6502:
	rts
L_NonUSA_FF6504:
	dc.l	$00FF8370
...
L_NonUSA_FF6552:
	adda.w	#$2, a1
L_NonUSA_FF6556:
	dbra	d0, L_NonUSA_FF654E
L_NonUSA_FF655A:
	adda.w	#$50, a0
L_NonUSA_FF655E:
	dbra	d2, L_NonUSA_FF654A
L_NonUSA_FF6562:
	dbra	d3, L_NonUSA_FF652C
L_NonUSA_FF6566:
	movem.l	(a7)+, d0-d3/a0-a2
L_NonUSA_FF656A:
	rts
L_NonUSA_FF656C:
	dc.w	$0004
	dc.b	$10,$01,$07,$02,$01,$10,$00,$09
	dc.b	$0E,$10,$00,$09,$1A,$10,$00,$09
	dc.b	$27,$10,$00,$09
L_NonUSA_FF6582:
	movem.l	d0-d7/a1-a5, -(a7)
L_NonUSA_FF6586:
...
L_NonUSA_FF65C6:
	add.w	d1, d1
L_NonUSA_FF65C8:
	jmp	L_NonUSA_FF6618(pc, d1.w)
L_NonUSA_FF65CC:
	move.w	a2, (a1)+
L_NonUSA_FF65CE:
	addq.w	#$1, a2
L_NonUSA_FF65D0:
	dbra	d2, L_NonUSA_FF65CC
L_NonUSA_FF65D4:
	bra.b	L_NonUSA_FF65A2
L_NonUSA_FF65D6:
	move.w	a4, (a1)+
L_NonUSA_FF65D8:
	dbra	d2, L_NonUSA_FF65D6
L_NonUSA_FF65DC:
	bra.b	L_NonUSA_FF65A2
L_NonUSA_FF65DE:
	bsr.w	$FF6640
...
L_NonUSA_FF65FE:
	subq.w	#$1, d1
L_NonUSA_FF6600:
	dbra	d2, L_NonUSA_FF65FC
L_NonUSA_FF6604:
	bra.b	L_NonUSA_FF65A2
L_NonUSA_FF6606:
	cmpi.w	#$f, d2
L_NonUSA_FF660A:
	beq.b	L_NonUSA_FF6628
L_NonUSA_FF660C:
	bsr.w	$FF6640
L_NonUSA_FF6610:
	move.w	d1, (a1)+
L_NonUSA_FF6612:
	dbra	d2, L_NonUSA_FF660C
L_NonUSA_FF6616:
	bra.b	L_NonUSA_FF65A2
L_NonUSA_FF6618:
	bra.b	L_NonUSA_FF65CC
	bra.b	L_NonUSA_FF65CC
	bra.b	L_NonUSA_FF65D6
	bra.b	L_NonUSA_FF65D6
	bra.b	L_NonUSA_FF65DE
	bra.b	L_NonUSA_FF65EA
	bra.b	L_NonUSA_FF65F8
	bra.b	L_NonUSA_FF6606
L_NonUSA_FF6628:
	subq.w	#$1, a0
L_NonUSA_FF662A:
	cmpi.w	#$10, d6
L_NonUSA_FF662E:
	bne.b	L_NonUSA_FF6632
L_NonUSA_FF6630:
	subq.w	#$1, a0
L_NonUSA_FF6632:
	move.w	a0, d0
...
L_NonUSA_FF6644:
	add.b	d1, d1
L_NonUSA_FF6646:
	bcc.b	L_NonUSA_FF6652
L_NonUSA_FF6648:
	subq.w	#$1, d6
L_NonUSA_FF664A:
	btst.l	d6, d5
L_NonUSA_FF664C:
	beq.b	L_NonUSA_FF6652
L_NonUSA_FF664E:
	ori.w	#$8000, d3
L_NonUSA_FF6652:
	add.b	d1, d1
L_NonUSA_FF6654:
	bcc.b	L_NonUSA_FF6660
L_NonUSA_FF6656:
	subq.w	#$1, d6
L_NonUSA_FF6658:
	btst.l	d6, d5
L_NonUSA_FF665A:
	beq.b	L_NonUSA_FF6660
L_NonUSA_FF665C:
	addi.w	#$4000, d3
L_NonUSA_FF6660:
	add.b	d1, d1
L_NonUSA_FF6662:
	bcc.b	L_NonUSA_FF666E
L_NonUSA_FF6664:
	subq.w	#$1, d6
L_NonUSA_FF6666:
	btst.l	d6, d5
L_NonUSA_FF6668:
	beq.b	L_NonUSA_FF666E
L_NonUSA_FF666A:
	addi.w	#$2000, d3
L_NonUSA_FF666E:
	add.b	d1, d1
L_NonUSA_FF6670:
	bcc.b	L_NonUSA_FF667C
L_NonUSA_FF6672:
	subq.w	#$1, d6
L_NonUSA_FF6674:
	btst.l	d6, d5
L_NonUSA_FF6676:
	beq.b	L_NonUSA_FF667C
L_NonUSA_FF6678:
	ori.w	#$1000, d3
L_NonUSA_FF667C:
	add.b	d1, d1
L_NonUSA_FF667E:
	bcc.b	L_NonUSA_FF668A
L_NonUSA_FF6680:
	subq.w	#$1, d6
L_NonUSA_FF6682:
	btst.l	d6, d5
L_NonUSA_FF6684:
	beq.b	L_NonUSA_FF668A
L_NonUSA_FF6686:
	ori.w	#$800, d3
L_NonUSA_FF668A:
	move.w	d5, d1
...
L_NonUSA_FF6BFE:
	...
	dc.l	$C78F1E3C
L_NonUSA_FF6C7E:
	dc.b	$71,$8D,$A3,$48,$3C,$60,$00,$00,$30,$00,$00,$0C
