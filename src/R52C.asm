...
; ------------------------------------------------------------------------------
	...
	include "src/r5/background_swap_2c.asm"
	include "src/r5/scroll_2c.asm"
	include "src/r5/stage_draw_2c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r5/stage_data_load_2c.asm"
	...
	include "src/r5/section_gfx_2c.asm"
	...
	include "src/r5/stage_gfx_animate_2c.asm"
	include "src/r5/gfx_lists_2c.asm"
	include "src/r5/data_2c.asm"
