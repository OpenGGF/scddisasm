...
; ------------------------------------------------------------------------------
	...
	include "src/r8/palette_cycle_d.asm"
	...
	include "src/r8/scroll_1d.asm"
	include "src/r8/stage_draw_1d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r8/stage_data_load_1d.asm"
	...
	include "src/r8/stage_gfx_animate_1d.asm"
	include "src/r8/gfx_lists_1d.asm"
	include "src/r8/data_1d.asm"
