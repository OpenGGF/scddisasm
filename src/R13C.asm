...
; ------------------------------------------------------------------------------
	...
	include "src/r1/scroll_3c.asm"
	include "src/r1/stage_draw_3c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r1/stage_data_load_3c.asm"
	...
	include "src/r1/section_gfx_3c.asm"
	...
	include "src/r1/stage_gfx_animate_3c.asm"
	include "src/r1/gfx_lists_3c.asm"
	include "src/r1/data_3c.asm"
