...
; ------------------------------------------------------------------------------
	...
	include "src/r6/scroll_1c.asm"
	include "src/r6/stage_draw_1c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r6/stage_data_load_1c.asm"
	...
	include "src/r6/debug_objects_1c_1d.asm"
	...
	include "src/r6/section_gfx_1c.asm"
	...
	include "src/r6/stage_gfx_animate_1c.asm"
	include "src/r6/gfx_lists_1c.asm"
	include "src/r6/data_1c.asm"
