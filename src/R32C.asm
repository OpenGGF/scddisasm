...
; ------------------------------------------------------------------------------
	...
	include "src/r3/scroll_2c.asm"
	include "src/r3/stage_draw_2c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r3/stage_data_load_2c.asm"
	...
	include "src/r3/debug_objects_2c.asm"
	...
	include "src/r3/section_gfx_2c.asm"
	...
	include "src/r3/stage_gfx_animate_2c.asm"
	include "src/r3/gfx_lists_2c.asm"
	include "src/r3/data_2c.asm"
