...
; ------------------------------------------------------------------------------
	...
	include "src/r3/scroll_2d.asm"
	include "src/r3/stage_draw_2d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r3/stage_data_load_2d.asm"
	...
	include "src/r3/debug_objects_2d.asm"
	...
	include "src/r3/section_gfx_2d.asm"
	...
	include "src/r3/stage_gfx_animate_2d.asm"
	include "src/r3/gfx_lists_2d.asm"
	include "src/r3/data_2d.asm"
