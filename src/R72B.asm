...
; ------------------------------------------------------------------------------
	...
	include "src/r7/scroll_2b.asm"
	include "src/r7/stage_draw_2b.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r7/stage_data_load_2b.asm"
	...
	include "src/r7/section_gfx_2b.asm"
	...
	include "src/r7/stage_gfx_animate_2b.asm"
	include "src/r7/gfx_lists_2b.asm"
	include "src/r7/data_2b.asm"
