...
; ------------------------------------------------------------------------------
	...
	if REGION=USA
	include	"r5/usa_gfx_tail_1d.asm"
	endif

Padding1:
	if REGION=USA
	include	"r5/usa_pre_chunks_1d.asm"
	else
	dc.w	$0023, $F5A4, $90E0, $0023, $F758, $94E0, $0023, $F3F2
	dc.w	$9A40, $0000, $0023, $EC48, $76C0, $0000, $0023, $DD50
	dc.w	$76C0, $0000, $0023, $0098, $7880, $0000, $0023, $C176
	dc.w	$4160, $0000, $0023, $CA96, $4140, $0002, $0022, $FABC
	dc.w	$8780, $0022, $F4F2, $9100, $0020, $B94C, $7DE0, $0000
	dc.w	$0023, $D9E0, $9740, $0000, $0023, $DB9E, $9740, $DAE0
	dc.w	$0023, $2E48, $F5C0, $000D, $0022, $F8FC, $5980, $0023
	dc.w	$E1B0, $6840, $0023, $DFB8, $6A00, $0023, $DF16, $6B00
	dc.w	$0023, $ED9C, $7200, $0023, $E906, $76C0, $0023, $E750
	dc.w	$7FC0, $0023, $E3B6, $8280, $0023, $E03E, $8960, $0023
	dc.w	$DD8A, $8D60, $0023, $F1FC, $90E0, $0023, $F460, $94E0
	dc.w	$0023, $D61A, $9740, $0023, $F0B0, $9A40, $0000, $0023
	dc.w	$0098, $7880, $0000, $0023, $C520, $4B40, $0000, $0023
	dc.w	$CB92, $4B40, $0002, $0022, $FABC, $8780, $0022, $F4F2
	dc.w	$9100, $0020, $BA40, $7DE0
...
Padding2:
	include	"Level/Quartz Quadrant/Data/R51 Padding 2.asm"
...
StageCollision:
	incbin	"maps/r51d/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r51d/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r51d/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r51d/blocks.nem"
	even

StageGfx:
	incbin	"maps/r51d/gfx.nem"
	even
...
StalactiteGfxD:
	incbin	"gfx/r5/stalactite_d.nem"
	even

RockGfxD:
	incbin	"gfx/r5/rock_d.nem"
	even
...
SinePlatformGfxD:
	incbin	"gfx/r5/sine_platform_d.nem"
	even

CrackFloorGfxD:
	incbin	"gfx/r5/crack_floor_d.nem"

Padding3:
	include	"r5/nonusa_padding_1d_3.asm"
