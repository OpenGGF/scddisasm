...
StageChunks:
	incbin	"src/maps/r52c/chunks.bin"
...
BossGfx1:
	incbin	"src/data/r52c/BossGfx1.bin"
	even

BossGfx2:
	incbin	"src/data/r52c/BossGfx2.bin"
	even
...
StageCollision:
	incbin	"src/maps/r52c/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r52c/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r52c/background.bin"
	even

StageMapNull:
	incbin	"src/data/r52c/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r52c/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r52c/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r52c/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r52c/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r52c/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r52c/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r52c/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r52c/byte_21D7A6.bin"
	even
...
InsideBgGfx:
	incbin	"src/data/r52c/InsideBgGfx.bin"
	even

OutsideBgGfx:
	incbin	"src/data/r52c/OutsideBgGfx.bin"
	even

BridgeGfx:
	incbin	"src/data/r52c/BridgeGfx.bin"
	even

ConveyorControlGfx:
	incbin	"src/data/r52c/ConveyorControlGfx.bin"
	even

PlatformGfx:
	incbin	"src/data/r52c/PlatformGfx.bin"
	even
...
BreakWallGfx:
	incbin	"src/data/r52c/BreakWallGfx.bin"
	even

ChainGfx:
	incbin	"src/data/r52c/ChainGfx.bin"
	even

CollapseFloorGfx:
	incbin	"src/data/r52c/CollapseFloorGfx.bin"
	even
...
StalactiteGfx:
	incbin	"src/data/r52c/StalactiteGfx.bin"
	even

RockGfx:
	incbin	"src/data/r52c/RockGfx.bin"
	even

KumoKumoGfx:
	incbin	"src/data/r52c/KumoKumoGfx.bin"
	even

KemusiGfx:
	incbin	"src/data/r52c/KemusiGfx.bin"
	even

SasoriGfx:
	incbin	"src/data/r52c/SasoriGfx.bin"
	even

NoroNoroGfx:
	incbin	"src/data/r52c/NoroNoroGfx.bin"
	even

SinePlatformGfx:
	incbin	"src/data/r52c/SinePlatformGfx.bin"
	even

CollapseFloorGfx2:
	incbin	"src/data/r52c/CollapseFloorGfx2.bin"
