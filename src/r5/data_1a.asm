...
StageChunks:
	incbin	"src/maps/r51a/chunks.bin"
...
StageCollision:
	incbin	"src/maps/r51a/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r51a/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r51a/background.bin"
	even
...
StageBlocks:
	incbin	"src/maps/r51a/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r51a/gfx.nem"
	even
