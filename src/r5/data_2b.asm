...
; ------------------------------------------------------------------------------
	...
	if REGION=USA
		include	"r5/usa_gfx_tail_2b.asm"
	endif

Padding1:
	if REGION=USA
		include	"r5/usa_pre_chunks_2b.asm"
	else
		include	"Level/Quartz Quadrant/Data/R52B Pre-Chunks (Non-USA).asm"
	endif

StageChunks:
	incbin	"maps/r52b/chunks.bin"

Padding2:
	incbin	"maps/r51a/chunks.bin",$D800,$200
R52_PADDING2_SKIP_FIRST_200 equ 1
...
StageCollision:
	incbin	"maps/r52b/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r52b/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r52b/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r52b/blocks.nem"
	even

StageGfx:
	incbin	"maps/r52b/gfx.nem"
	even
...
Padding3:
	include	"Level/Wacky Workbench/Data/Legacy Padding 3/Suffix 2050.asm"
