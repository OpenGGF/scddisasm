...
Padding1:
	incbin	"padding/r52b_e_1.bin"

StageChunks:
	incbin	"src/maps/r52b/chunks.bin"

Padding2:
	incbin	"padding/r52b_e_2.bin"
...
BossGfx1:
	incbin	"src/data/r52b/BossGfx1.bin"
	even

BossGfx2:
	incbin	"src/data/r52b/BossGfx2.bin"
	even
...
StageCollision:
	incbin	"src/maps/r52b/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r52b/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r52b/background.bin"
	even

StageMapNull:
	incbin	"src/data/r52b/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r52b/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r52b/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r52b/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r52b/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r52b/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r52b/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r52b/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r52b/byte_21D7A6.bin"
	even
...
InsideBgGfx:
	incbin	"src/data/r52b/InsideBgGfx.bin"
	even

OutsideBgGfx:
	incbin	"src/data/r52b/OutsideBgGfx.bin"
	even

BridgeGfx:
	incbin	"src/data/r52b/BridgeGfx.bin"
	even

ConveyorControlGfx:
	incbin	"src/data/r52b/ConveyorControlGfx.bin"
	even

PlatformGfx:
	incbin	"src/data/r52b/PlatformGfx.bin"
	even
...
BreakWallGfx:
	incbin	"src/data/r52b/BreakWallGfx.bin"
	even

ChainGfx:
	incbin	"src/data/r52b/ChainGfx.bin"
	even

CollapseFloorGfx:
	incbin	"src/data/r52b/CollapseFloorGfx.bin"
	even
...
StalactiteGfx:
	incbin	"src/data/r52b/StalactiteGfx.bin"
	even

RockGfx:
	incbin	"src/data/r52b/RockGfx.bin"
	even

KumoKumoGfx:
	incbin	"src/data/r52b/KumoKumoGfx.bin"
	even

KemusiGfx:
	incbin	"src/data/r52b/KemusiGfx.bin"
	even

SasoriGfx:
	incbin	"src/data/r52b/SasoriGfx.bin"
	even

NoroNoroGfx:
	incbin	"src/data/r52b/NoroNoroGfx.bin"
	even
...
UnusedSinePlatformGfx:
	incbin	"src/data/r52b/UnusedSinePlatformGfx.bin"
	even

CrackedCollapseFloorGfx:
	incbin	"src/data/r52b/CrackedCollapseFloorGfx.bin"

Padding3:
	incbin	"padding/r52b_e_3.bin"
