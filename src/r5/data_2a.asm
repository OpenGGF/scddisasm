...
; ------------------------------------------------------------------------------
	...
	if REGION=USA
		include	"r5/usa_gfx_tail_2a.asm"
	endif

Padding1:
	if REGION=USA
		include	"r5/usa_pre_chunks_2a.asm"
	else
	incbin	"../padding/r52a_e_1.bin"
	endif

StageChunks:
	incbin	"maps/r52a/chunks.bin"
...
StageCollision:
	incbin	"maps/r52a/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r52a/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r52a/background.bin"
	even

StageMapNull:
	incbin	"maps/r52a/background_2.bin"
	even
...
StageBlocks:
	incbin	"maps/r52a/blocks.nem"
	even

StageGfx:
	incbin	"maps/r52a/gfx.nem"
	even
...
Padding3:
	incbin	"Level/Wacky Workbench/Data/Padding/3 (Act 1 Present).bin", $1D56, $AA8
