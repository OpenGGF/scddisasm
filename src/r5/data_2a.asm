...
Padding1:
	incbin	"padding/r52a_e_1.bin"

StageChunks:
	incbin	"src/maps/r52a/chunks.bin"

Padding2:
	incbin	"padding/r52a_e_2.bin"
...
BossGfx1:
	incbin	"src/data/r52a/BossGfx1.bin"
	even

BossGfx2:
	incbin	"src/data/r52a/BossGfx2.bin"
	even
...
StageCollision:
	incbin	"src/maps/r52a/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r52a/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r52a/background.bin"
	even

StageMapNull:
	incbin	"src/data/r52a/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r52a/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r52a/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r52a/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r52a/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r52a/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r52a/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r52a/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r52a/byte_21D7A6.bin"
	even
...
InsideBgGfx:
	incbin	"src/data/r52a/InsideBgGfx.bin"
	even

OutsideBgGfx:
	incbin	"src/data/r52a/OutsideBgGfx.bin"
	even

BridgeGfx:
	incbin	"src/data/r52a/BridgeGfx.bin"
	even

ConveyorControlGfx:
	incbin	"src/data/r52a/ConveyorControlGfx.bin"
	even

PlatformGfx:
	incbin	"src/data/r52a/PlatformGfx.bin"
	even
...
BreakWallGfx:
	incbin	"src/data/r52a/BreakWallGfx.bin"
	even

ChainGfx:
	incbin	"src/data/r52a/ChainGfx.bin"
	even

CollapseFloorGfx:
	incbin	"src/data/r52a/CollapseFloorGfx.bin"
	even
...
StalactiteGfx:
	incbin	"src/data/r52a/StalactiteGfx.bin"
	even

RockGfx:
	incbin	"src/data/r52a/RockGfx.bin"
	even

KumoKumoGfx:
	incbin	"src/data/r52a/KumoKumoGfx.bin"
	even

KemusiGfx:
	incbin	"src/data/r52a/KemusiGfx.bin"
	even

SasoriGfx:
	incbin	"src/data/r52a/SasoriGfx.bin"
	even

NoroNoroGfx:
	incbin	"src/data/r52a/NoroNoroGfx.bin"
	even

RobotGeneratorDecayGfx:
	incbin	"src/gfx/r5/robot_generator_decay.nem"
	even

UnusedSinePlatformGfx:
	incbin	"src/data/r52a/UnusedSinePlatformGfx.bin"
	even

CrackedCollapseFloorGfx:
	incbin	"src/data/r52a/CrackedCollapseFloorGfx.bin"

Padding3:
	incbin	"padding/r52a_e_3.bin"
