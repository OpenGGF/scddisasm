...
; ------------------------------------------------------------------------------
	...
	if REGION=USA
		include	"r5/usa_gfx_tail_1c.asm"
	endif

Padding1:
	if REGION=USA
		include	"r5/usa_pre_chunks_1c.asm"
	else
		dc.w	$0001, $0023, $8FCE, $0000, $0023, $C176, $4160, $000E
		dc.w	$0023, $D4CC, $6000, $0023, $D6A4, $6080, $0023, $D534
		dc.w	$F2E0, $0023, $E5E4, $6640, $0023, $0DA2, $6C00, $0023
		dc.w	$39E4, $7A00, $0023, $D9E0, $9740, $0023, $1E2E, $9E40
		dc.w	$0023, $213A, $A400, $0023, $34BC, $AD00, $0023, $235C
		dc.w	$B500, $0023, $2960, $D000, $0022, $EDE6, $D8C0, $0023
		dc.w	$3732, $DAE0, $0023, $2E48, $F5C0, $000C, $0022, $F8FC
		dc.w	$5740, $0023, $E528, $6840, $0023, $E346, $6A00, $0023
		dc.w	$E2A4, $6B00, $0023, $F0DE, $7200, $0023, $EC48, $76C0
		dc.w	$0023, $EA92, $7FC0, $0023, $E6F8, $8280, $0023, $E3B6
		dc.w	$8960, $0023, $E150, $8D60, $0023, $F5A4, $90E0, $0023
		dc.w	$F758, $94E0, $0023, $F3F2, $9A40, $000C, $0022, $F8FC
		dc.w	$5740, $0023, $E528, $6840, $0023, $E346, $6A00, $0023
		dc.w	$E2A4, $6B00, $0023, $F0DE, $7200, $0023, $DD50, $76C0
		dc.w	$0023, $EA92, $7FC0, $0023, $E6F8, $8280, $0023, $E3B6
		dc.w	$8960, $0023, $E150, $8D60, $0023, $F5A4, $90E0, $0023
		dc.w	$F758, $94E0, $0023, $F3F2, $9A40, $0000, $0023, $EC48
		dc.w	$76C0, $0000, $0023, $DD50, $76C0, $0000, $0023, $0098
		dc.w	$7880, $0000, $0023, $C176, $4160, $0000, $0023, $CA96
		dc.w	$4140, $0002, $0022, $FABC, $8780, $0022, $F4F2, $9100
		dc.w	$0020, $B94C, $7DE0, $0000, $0023, $D9E0, $9740, $0000
		dc.w	$0023, $DB9E, $9740
...
StageCollision:
	incbin	"maps/r51c/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r51c/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r51c/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r51c/blocks.nem"
	even

StageGfx:
	incbin	"maps/r51c/gfx.nem"
	even
...
SinePlatformGfxC:
	incbin	"gfx/r5/sine_platform_c.nem"
	even
