...
; ------------------------------------------------------------------------------
	...
	if REGION=USA
		include	"r5/usa_gfx_tail_2d.asm"
	endif

Padding1:
	if REGION=USA
		include	"r5/usa_pre_chunks_2d.asm"
	else
		include	"Level/Quartz Quadrant/Data/R52D Pre-Chunks (Non-USA).asm"
	endif

StageChunks:
	incbin	"maps/r52d/chunks.bin"
...
StageCollision:
	incbin	"maps/r52d/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r52d/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r52d/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r52d/blocks.nem"
	even

StageGfx:
	incbin	"maps/r52d/gfx.nem"
	even
