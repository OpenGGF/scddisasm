...
; ------------------------------------------------------------------------------
	...
	include "src/r4/scroll_2a.asm"
	include "src/r4/stage_draw_2a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r4/stage_data_load_2a.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r4/object_index_2a.asm"
	...
	include "src/r4/debug_objects_2a.asm"
	...
	include "src/r4/water_currents_2a.asm"
	include "src/r4/section_gfx_2a.asm"
	...
	include "src/objects/r4/wood_block.asm"
	include "src/objects/r4/move_wall.asm"
	include "src/objects/r4/boss_door.asm"
	include "src/objects/r4/shooter.asm"
	include "src/objects/r4/break_block.asm"
	include "src/objects/r4/robot_generator.asm"
	include "src/common/time_check.asm"
	include "src/r4/stage_gfx_animate_2a.asm"
	include "src/r4/gfx_lists_2a.asm"
	include "src/r4/data_2a.asm"
