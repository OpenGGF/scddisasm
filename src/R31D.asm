...
; ------------------------------------------------------------------------------
	...
	include "src/r3/palette_cycle_d.asm"
	...
	include "src/r3/scroll_1d.asm"
	include "src/r3/stage_draw_1d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r3/stage_data_load_1d.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r3/object_index_1b_1c_1d.asm"
	...
	include "src/r3/debug_objects_1d.asm"
	...
	include "src/r3/section_gfx_1d.asm"
	...
	include "src/r3/stage_gfx_animate_1d.asm"
	include "src/r3/gfx_lists_1d.asm"
	include "src/r3/data_1d.asm"
