...
StageChunks:
	incbin	"src/maps/r41c/chunks.bin"
	even

BreakPoleGfx:
	incbin	"src/data/r41c/BreakPoleGfx.bin"
	even
...
UnusedThinPlatformGfx:
	incbin	"src/data/r41c/UnusedThinPlatformGfx.bin"
	even

BlockGoodFutureGfx:
	incbin	"src/data/r41c/BlockGoodFutureGfx.bin"
	even
...
SwingGfx:
	incbin	"src/data/r41c/SwingGfx.bin"
	even

PrizePointsGfx:
	incbin	"src/data/r41c/PrizePointsGfx.bin"
	even

DoorGoodFutureGfx:
	incbin	"src/data/r41c/DoorGoodFutureGfx.bin"
	even

RotateBlockGfx:
	incbin	"src/data/r41c/RotateBlockGfx.bin"
	even

GeyserGfx:
	incbin	"src/data/r41c/GeyserGfx.bin"
	even

UnusedPlatformGfx:
	incbin	"src/data/r41c/UnusedPlatformGfx.bin"
	even

SlopeElevatorGfx:
	incbin	"src/data/r41c/SlopeElevatorGfx.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r41c/SpikeBallGfx.bin"
	even

ChainGfx:
	incbin	"src/data/r41c/ChainGfx.bin"
	even

TurbineGfx:
	incbin	"src/data/r41c/TurbineGfx.bin"
	even

CollapseFloorGfx:
	incbin	"src/data/r41c/CollapseFloorGfx.bin"
	even

ElectricBeamGfx:
	incbin	"src/data/r41c/ElectricBeamGfx.bin"
	even

ShooterGfx:
	incbin	"src/data/r41c/ShooterGfx.bin"
	even

TonboGfx:
	incbin	"src/data/r41c/TonboGfx.bin"
	even
...
YagoGfx:
	incbin	"src/data/r41c/YagoGfx.bin"
	even

FloatElevatorGfx:
	incbin	"src/data/r41c/FloatElevatorGfx.bin"
	even

AmenboGfx:
	incbin	"src/data/r41c/AmenboGfx.bin"
	even

WoodBlockGfx:
	incbin	"src/data/r41c/WoodBlockGfx.bin"
	even
...
byte_21D7A6:
	incbin	"src/data/r41c/byte_21D7A6.bin"
	even
...
WaterSurfaceGfx:
	incbin	"src/data/r41c/WaterSurfaceGfx.bin"
	even
...
BubbleNumbersGfx:
	incbin	"src/data/r41c/BubbleNumbersGfx.bin"
	even

Spr_21E9B4:
	include	"src/data/r41c/Spr_21E9B4.asm"
	even
...
StageCollision:
	incbin	"src/maps/r41c/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r41c/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r41c/background.bin"
	even

StageMapNull:
	incbin	"src/data/r41c/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r41c/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r41c/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r41c/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r41c/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r41c/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r41c/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r41c/gfx.nem"
