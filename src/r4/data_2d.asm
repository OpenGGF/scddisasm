...
BreakPoleGfx:
	incbin	"src/data/r42d/BreakPoleGfx.bin"
	even
...
UnusedThinPlatformGfx:
	incbin	"src/data/r42d/UnusedThinPlatformGfx.bin"
	even

BlockGfxsBadFuture:
	incbin	"src/data/r42d/BlockGfxsBadFuture.bin"
	even
...
SwingGfx:
	incbin	"src/data/r42d/SwingGfx.bin"
	even

PrizePointsGfx:
	incbin	"src/data/r42d/PrizePointsGfx.bin"
	even

Art_DoorBadFuture:
	incbin	"src/data/r42d/Art_DoorBadFuture.bin"
	even

GeyserGfx:
	incbin	"src/data/r42d/GeyserGfx.bin"
	even

UnusedPlatformGfx:
	incbin	"src/data/r42d/UnusedPlatformGfx.bin"
	even

SlopeElevatorGfx:
	incbin	"src/data/r42d/SlopeElevatorGfx.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r42d/SpikeBallGfx.bin"
	even

ChainGfx:
	incbin	"src/data/r42d/ChainGfx.bin"
	even

TurbineGfx:
	incbin	"src/data/r42d/TurbineGfx.bin"
	even

CollapseFloorGfx:
	incbin	"src/data/r42d/CollapseFloorGfx.bin"
	even

ElectricBeamGfx:
	incbin	"src/data/r42d/ElectricBeamGfx.bin"
	even

ShooterGfx:
	incbin	"src/data/r42d/ShooterGfx.bin"
	even

TonboGfx:
	incbin	"src/data/r42d/TonboGfx.bin"
	even
...
YagoGfx:
	incbin	"src/data/r42d/YagoGfx.bin"
	even

FloatElevatorGfx:
	incbin	"src/data/r42d/FloatElevatorGfx.bin"
	even

AmenboGfx:
	incbin	"src/data/r42d/AmenboGfx.bin"
	even

WoodBlockGfx:
	incbin	"src/data/r42d/WoodBlockGfx.bin"
	even
...
WaterSurfaceGfx:
	incbin	"src/data/r42d/WaterSurfaceGfx.bin"
	even
...
BubbleNumbersGfx:
	incbin	"src/data/r42d/BubbleNumbersGfx.bin"
	even

Spr_21E9B4:
	include	"src/data/r42d/Spr_21E9B4.asm"
	even
...
StageCollision:
	incbin	"src/maps/r42d/collision.bin"
	even
...
StageMapFg:
	incbin	"src/maps/r42d/foreground.bin"
	even

StageMapBg:
	incbin	"src/maps/r42d/background.bin"
	even

StageMapNull:
	incbin	"src/data/r42d/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r42d/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r42d/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r42d/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r42d/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r42d/StageMapUnk5.bin"
	even

StageBlocks:
	incbin	"src/maps/r42d/blocks.nem"
	even

StageGfx:
	incbin	"src/maps/r42d/gfx.nem"
	even
...
byte_21D7A6:
	incbin	"src/data/r42d/byte_21D7A6.bin"
	even
