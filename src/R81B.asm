...
; ------------------------------------------------------------------------------
	...
	include "src/r8/palette_cycle_b.asm"
	...
	include "src/r8/scroll_1b.asm"
	include "src/r8/stage_draw_1b.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r8/stage_data_load_1b.asm"
	...
	include "src/r8/stage_gfx_animate_1b.asm"
	include "src/r8/gfx_lists_1b.asm"
	include "src/r8/data_1b.asm"
