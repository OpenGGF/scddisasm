...
; ------------------------------------------------------------------------------
	...
	include "src/r1/palette_cycle_b.asm"
	...
	include "src/r1/scroll_1b.asm"
	include "src/r1/stage_draw_1b.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r1/stage_data_load_1b.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r1/object_index_1b_1c_1d.asm"
	...
	include "src/r1/debug_objects_1b.asm"
	include "src/common/object_spawn.asm"
	include "src/r1/stage_object_maps_1.asm"
	...
	include "src/r1/collapse_data_1b.asm"
	include "src/objects/r1/platform.asm"
	include "src/objects/r1/v_door.asm"
	include "src/r1/section_gfx_1b.asm"
	...
	include "src/r1/stage_gfx_animate_1b.asm"
	include "src/r1/gfx_lists_1b.asm"
	include "src/r1/data_1b.asm"
