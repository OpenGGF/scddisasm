...
; ------------------------------------------------------------------------------
	...
	include "src/r5/palette_cycle_b.asm"
	...
	include "src/r5/background_swap_1b.asm"
	include "src/r5/scroll_1b.asm"
	include "src/r5/stage_draw_1b.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r5/stage_data_load_1b.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r5/object_index_1_2.asm"
	...
	include "src/r5/debug_objects_1_2.asm"
	include "src/common/object_spawn.asm"
	include "src/r5/stage_object_maps_1.asm"
	...
	include "src/r5/section_gfx_1b.asm"
	...
	include "src/r5/stage_gfx_animate_1b.asm"
	include "src/r5/gfx_lists_1b.asm"
	include "src/r5/data_1b.asm"
