...
; ------------------------------------------------------------------------------
	...
	include "src/r6/scroll_1a.asm"
	include "src/r6/stage_draw_1a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r6/stage_data_load_1a.asm"
	...
	include "src/r6/debug_objects_1a.asm"
	...
	include "src/r6/section_gfx_1a.asm"
	...
	include "src/r6/stage_gfx_animate_1a.asm"
	include "src/r6/gfx_lists_1a.asm"
	include "src/r6/data_1a.asm"
