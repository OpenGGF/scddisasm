...
; ------------------------------------------------------------------------------
	...
	include "src/r3/scroll_1c.asm"
	include "src/r3/stage_draw_1c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r3/stage_data_load_1c.asm"
	...
	include "src/r3/debug_objects_1c.asm"
	...
	include "src/r3/section_gfx_1c.asm"
	...
	include "src/r3/stage_gfx_animate_1c.asm"
	include "src/r3/gfx_lists_1c.asm"
	include "src/r3/data_1c.asm"
