...
; ------------------------------------------------------------------------------
	...
	include "src/r4/scroll_1c.asm"
	include "src/r4/stage_draw_1c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r4/stage_data_load_1c.asm"
	...
	include "src/r4/section_gfx_1c.asm"
	...
	include "src/r4/stage_gfx_animate_1c.asm"
	include "src/r4/gfx_lists_1c.asm"
	include "src/r4/data_1c.asm"
