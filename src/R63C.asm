...
; ------------------------------------------------------------------------------
	...
	include "src/r6/palette_cycle_c.asm"
	...
	include "src/r6/scroll_3c.asm"
	include "src/r6/stage_draw_3c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r6/stage_data_load_3c.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r6/object_index_3.asm"
	...
	include "src/r6/debug_objects_3.asm"
	include "src/common/object_spawn.asm"
	include "src/r6/stage_object_maps_3.asm"
	...
	include "src/sprites/title_card_r6.asm"
	...
	include "src/r6/section_gfx_3c.asm"
	...
	include "src/objects/r6/crusher.asm"
	...
	include "src/objects/r6/spike_chain.asm"
	include "src/objects/r6/robot_generator.asm"
	include "src/objects/r6/projector.asm"
	include "src/common/time_check.asm"
	include "src/r6/stage_gfx_animate_3c.asm"
	include "src/r6/gfx_lists_3c.asm"
	include "src/objects/r6/boss.asm"
	include "src/r6/data_3c.asm"
