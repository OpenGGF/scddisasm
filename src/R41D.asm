...
; ------------------------------------------------------------------------------
	...
	include "src/r4/scroll_1d.asm"
	include "src/r4/stage_draw_1d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r4/stage_data_load_1d.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r4/object_index_1c_1d.asm"
	...
	include "src/r4/debug_objects_1c_1d.asm"
	...
	include "src/r4/water_currents_1c_1d.asm"
	include "src/r4/section_gfx_1d.asm"
	...
	include "src/objects/r4/prize.asm"
	include "src/common/time_check.asm"
	include "src/objects/r4/elevator.asm"
	include "src/r4/stage_gfx_animate_1d.asm"
	include "src/r4/gfx_lists_1d.asm"
	include "src/r4/data_1d.asm"
