...
; ------------------------------------------------------------------------------
	...
	include "src/r7/scroll_1a.asm"
	include "src/r7/stage_draw_1a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r7/stage_data_load_1a.asm"
	...
	include "src/r7/section_gfx_1a.asm"
	...
	include "src/r7/stage_gfx_animate_1a.asm"
	include "src/r7/gfx_lists_1a.asm"
	include "src/r7/data_1a.asm"
