...
; ------------------------------------------------------------------------------
	...
	include "src/r6/scroll_2d.asm"
	include "src/r6/stage_draw_2d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r6/stage_data_load_2d.asm"
	...
	include "src/r6/debug_objects_2d.asm"
	...
	include "src/r6/section_gfx_2d.asm"
	...
	include "src/r6/stage_gfx_animate_2d.asm"
	include "src/r6/gfx_lists_2d.asm"
	include "src/r6/data_2d.asm"
