...
; ------------------------------------------------------------------------------
	...
	include "src/r1/scroll_1a.asm"
	include "src/r1/stage_draw_1a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r1/stage_data_load_1a.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r1/object_index_1a.asm"
	...
	include "src/r1/debug_objects_1a.asm"
	...
	include "src/r1/stage_gfx_animate_1a.asm"
	include "src/r1/gfx_lists_1a.asm"
	include "src/r1/data_1a.asm"
