...
; ------------------------------------------------------------------------------
	...
	include "src/r5/background_swap_2d.asm"
	include "src/r5/scroll_2d.asm"
	include "src/r5/stage_draw_2d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r5/stage_data_load_2d.asm"
	...
	include "src/r5/section_gfx_2d.asm"
	...
	include "src/r5/stage_gfx_animate_2d.asm"
	include "src/r5/gfx_lists_2d.asm"
	include "src/r5/data_2d.asm"
