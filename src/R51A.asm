...
; ------------------------------------------------------------------------------
	...
	include "src/r5/background_swap_1a.asm"
	include "src/r5/scroll_1a.asm"
	include "src/r5/stage_draw_1a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r5/stage_data_load_1a.asm"
	...
	include "src/r5/section_gfx_1a.asm"
	...
	include "src/r5/stage_gfx_animate_1a.asm"
	include "src/r5/gfx_lists_1a.asm"
	include "src/r5/data_1a.asm"
