...
; ------------------------------------------------------------------------------
	...
	include "src/r5/background_swap_2b.asm"
	include "src/r5/scroll_2b.asm"
	include "src/r5/stage_draw_2b.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r5/stage_data_load_2b.asm"
	...
	include "src/r5/section_gfx_2b.asm"
	...
	include "src/r5/stage_gfx_animate_2b.asm"
	include "src/r5/gfx_lists_2b.asm"
	include "src/r5/data_2b.asm"
