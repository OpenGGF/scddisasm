...
; Collision Chaos R32D historical entry graph
; -------------------------------------------------------------------------
...
CC2_VARIANT	EQU	CC_VARIANT
	...
	include	"r3/scroll_2d.asm"
	include	"r3/stage_draw_2d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include	"r3/stage_data_load_2d.asm"
	...
	include	"r3/debug_objects_2d.asm"
