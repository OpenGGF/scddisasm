...
; Collision Chaos R31D historical entry graph
; -------------------------------------------------------------------------
...
CC_VARIANT	EQU	3
	...
	include	"r3/scroll_1d.asm"
	include	"r3/stage_draw_1d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include	"r3/stage_data_load_1d.asm"
	...
	include	"r3/debug_objects_1d.asm"
	...
	include	"r3/stage_gfx_animate_1d.asm"
