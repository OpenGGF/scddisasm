...
; Collision Chaos R32C historical entry graph
; -------------------------------------------------------------------------
...
CC_VARIANT	EQU	2
	...
	include	"r3/scroll_2c.asm"
	include	"r3/stage_draw_2c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include	"r3/stage_data_load_2c.asm"
	...
	include	"r3/debug_objects_2c.asm"
	...
	include	"r3/gfx_lists_2c.asm"
	include	"r3/data_2c.asm"
