...
; Collision Chaos R32B historical entry graph
; -------------------------------------------------------------------------
...
CC_VARIANT	EQU	1
	...
	include	"r3/scroll_2b.asm"
	include	"r3/stage_draw_2b.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include	"r3/stage_data_load_2b.asm"
	...
	include	"r3/debug_objects_2b.asm"
	...
	include	"r3/gfx_lists_2b.asm"
	include	"r3/data_2b.asm"
