...
; Collision Chaos Act 2 shared entry graph
; -------------------------------------------------------------------------

	include	"Level/Initialization.asm"
	include	"Level/Collision Chaos/Palette Cycle (Act 2 Variant).asm"
	include	"Level/Palette Fade.asm"
	include	"Level/Palette Load (Fade).asm"
	include	"Level/Palette Load.asm"
	include	"Level/Collision Chaos/Palette Data (Act 2 Variant).asm"
	...
	include	"Level/Collision Chaos/Stage Draw (Act 2).asm"
	include	"Level/Block Draw.asm"
	include	"Level/Collision Chaos/Scroll (Act 2).asm"
	include	"Level/Palmtree Panic/Load Level Data.asm"
	include	"Level/_Events.asm"
	include	"Level/Object Functions.asm"
	include	"Level/Collision Chaos/Object Index (Act 2 Variant).asm"
	...
	include	"Level/Collision Chaos/Debug Objects (Act 2 Variant).asm"
	include	"Level/Object Spawner.asm"
	include	"Level/Collision Chaos/Object Layout (Act 2).asm"
	...
	include	"Level/Collision Chaos/Section Data (Act 2 Variant).asm"
	...
	include	"Level/Collision Chaos/Data (Act 2 Variant).asm"
