; ------------------------------------------------------------------------------
; R32C retained PLC records before the shared R31C pre-chunk stream.
...
; this retained range.
R32CRetainedAct2PastStandardPLCTail:
...
R32CRetainedAct2PastSection0PLC:
	dc.w	$C
...
R32CRetainedAct2PastSection1PLC:
	dc.w	$C
	dc.l	$00234D3A		; spikes
	dc.w	$63C0
	dc.l	$00234EAC		; block
...
R32CRetainedAct2PastSection2PLC:
	dc.w	0
	dc.l	$0023697A		; withered robot generator
	dc.w	$6D40
R32CRetainedAct2PastSection3PLC:
	dc.w	0
	dc.l	$00235246		; rotating platform
	dc.w	$6D40
R32CRetainedAct2PastResultsPLC:
	dc.w	0
	dc.l	$00230098		; Results art
	dc.w	$7880

; Three-entry Signpost PLC.
R32CRetainedAct2PastSignpostPLC:
	dc.w	2
...
R32CRetainedAct1PresentSectionPLCTail:
...
R32CRetainedAct1PresentResultsPLC:
	dc.w	0
	dc.l	$00230098		; Results art
	dc.w	$7880
R32CRetainedAct1PresentSignpostPLC:
	dc.w	2
	dc.l	$0022FABC		; signpost
	dc.w	$8780
	dc.l	$0022F4F2		; big ring
