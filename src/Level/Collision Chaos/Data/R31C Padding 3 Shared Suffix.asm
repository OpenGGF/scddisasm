...
; +$0000-+$24EB retained shared stream
; +$24EC-+$2537 shared mapping/animation tail
; +$2538-+$2639 shared spin-platform rotation-vector table
; ------------------------------------------------------------------------------
	...
	; Shared mapping/animation records complete the retained suffix.
