...
; -------------------------------------------------------------------------
; Palmtree Panic Act 2 Present object index
; -------------------------------------------------------------------------
...
ObjectIndex:
	...
	dc.l	ObjWaterfall			; $04 - Unused waterfall generator
	...
	dc.l	ObjCollapsePlatform		; $20 - Collapsing platform
	...
	dc.l	ObjSwing			; $29 - Swinging platform
