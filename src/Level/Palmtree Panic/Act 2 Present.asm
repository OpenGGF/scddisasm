...
; -------------------------------------------------------------------------
	...
	include	"Level/Palmtree Panic/Palette Data (Act 2 Present).asm"
	...
	include	"Level/Palmtree Panic/Scroll (Act 2 Present).asm"
	...
	include	"Level/Palmtree Panic/Debug Objects (Act 2 Present).asm"
	include	"Level/Object Spawner.asm"
	include	"Level/Palmtree Panic/Object Layout (Act 2 Present).asm"
	...
	include	"Level/Palmtree Panic/Section Data (Act 2 Present).asm"
	include	"Level/Object Tile ID Set.asm"
	include	"Level/Palmtree Panic/Object Tile IDs (Act 2 Present).asm"
	...
	include	"Level/Palmtree Panic/Animated Tiles Update (Act 2 Present).asm"
	include	"Level/Palmtree Panic/Data (Act 2 Present).asm"
