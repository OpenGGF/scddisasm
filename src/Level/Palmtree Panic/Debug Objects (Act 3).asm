...
; -------------------------------------------------------------------------
; Palmtree Panic Act 3 debug object index
; -------------------------------------------------------------------------
...
DebugItemIndex:
	...
	DBGITEM	$24, 3, MapSpr_FlyingAnimal,  $3CF, 0, 0, 0, 0
	DBGITEM	$24, 3, MapSpr_GroundAnimal,  $3CF, 1, 0, 0, 3
	DBGITEM	$22, 4, MapSpr_Tamabboh1,     $23E7, 0, 0, 0, 0
	...
	DBGITEM	$2A, 3, EggmanSprites,        $40C, 0, 0, 0, 0
