...
MapSpr_CollapsePlatform2:
	include	"Level/Palmtree Panic/Objects/Collapsing Platform/Data/Mappings (Act 1 Future).asm"
	even
...
MapSpr_CollapsePlatform4:
	include	"Level/Palmtree Panic/Objects/Collapsing Platform/Data/Mappings (Pieces 2, Act 1 Future).asm"
	even
