...
; -------------------------------------------------------------------------
; Palmtree Panic Act 2 Good Future
; -------------------------------------------------------------------------

	include	"Level/_Definitions.inc"
ACT2_FUTURE_VARIANT	EQU	1
STAGE_R13		EQU	0
...
; -------------------------------------------------------------------------
	...
	include	"Level/Palmtree Panic/Scroll (Act 2 Good Future).asm"
	include	"Level/Palmtree Panic/Load Level Data.asm"
	include	"Level/_Events.asm"
	include	"Level/Object Functions.asm"
	include	"Level/Palmtree Panic/Object Index (Act 2 Good Future).asm"
	...
	include	"Level/Palmtree Panic/Debug Objects (Act 2 Good Future).asm"
	include	"Level/Object Spawner.asm"
	include	"Level/Palmtree Panic/Object Layout (Act 2 Good Future).asm"
	...
	include	"Level/Palmtree Panic/Objects/Collapsing Platform/Data (Act 2 Good Future).asm"
	...
	include	"Level/Palmtree Panic/Section Data (Act 2 Good Future).asm"
	include	"Level/Object Tile ID Set.asm"
	include	"Level/Palmtree Panic/Object Tile IDs (Act 2 Good Future).asm"
	...
	include	"Level/Palmtree Panic/Animated Tiles Update (Act 2 Good Future).asm"
	include	"Level/Palmtree Panic/Data (Act 2 Good Future).asm"
