; -------------------------------------------------------------------------
; Tidal Tempest R41D historical source graph
; -------------------------------------------------------------------------
...
R6_LEGACY_PLAYER	EQU	1
	...
	include "Level/Tidal Tempest/R41D Legacy Scroll.asm"
	include "r4/stage_draw_1d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "r4/stage_data_load_1d.asm"
	...
	include "r4/debug_objects_1c_1d.asm"
	...
	include "r4/water_currents_1c_1d.asm"
	include "r4/section_gfx_1d.asm"
	...
	include "r4/stage_gfx_animate_1d.asm"
	include "r4/gfx_lists_1d.asm"
	include "r4/data_1d.asm"
