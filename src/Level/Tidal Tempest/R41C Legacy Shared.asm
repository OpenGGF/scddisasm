; -------------------------------------------------------------------------
; Tidal Tempest R41C historical source graph
; -------------------------------------------------------------------------
...
R6_LEGACY_PLAYER	EQU	1
	...
	include "Level/Tidal Tempest/R41C Legacy Scroll.asm"
	include "r4/stage_draw_1c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "r4/stage_data_load_1c.asm"
	...
	include "r4/stage_gfx_animate_1c.asm"
	include "r4/gfx_lists_1c.asm"
	include "r4/data_1c.asm"
