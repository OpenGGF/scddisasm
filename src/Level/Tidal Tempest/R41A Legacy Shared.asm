; -------------------------------------------------------------------------
; Tidal Tempest R41A historical source graph
; -------------------------------------------------------------------------
...
R6_LEGACY_PLAYER	EQU	1
	...
	include "Level/Tidal Tempest/R41A Legacy Scroll.asm"
	include "r4/stage_draw_1a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "r4/stage_data_load_1a.asm"
	include "r4/events.asm"
	...
	include "r4/debug_objects_1a.asm"
	...
	include "r4/water_currents_1a.asm"
	include "r4/section_gfx_1a.asm"
	...
	include "r4/stage_gfx_animate_1a.asm"
	include "r4/gfx_lists_1a.asm"
	include "r4/data_1a.asm"
