...
; ------------------------------------------------------------------------------
	...
	include "src/r8/scroll_2d.asm"
	include "src/r8/stage_draw_2d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r8/stage_data_load_2d.asm"
	...
	include "src/r8/stage_gfx_animate_2d.asm"
	include "src/r8/gfx_lists_2d.asm"
	include "src/r8/data_2d.asm"
