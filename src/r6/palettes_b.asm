...
StagePalette:
	...
	dc.b	0, $80, 2, $C6, 0, $EE, 0, $88, 0, $44, 0, $E, 8, $46
	dcb.b	2,$E
	dcb.b	2,6
	dcb.b	2,0
	dc.b	6, $E6, $E, $E8, $A, $E, 0, $E, 6, $EE, 0, $8E, 0, $4C, 0
	dc.b	6
	dcb.b	2,0
	dc.b	2, $42, 2, $A2, 4, $E2, 8, $46, 8, $42, $E, $44
	dcb.b	2,$E
	dc.b	4, $EE, 6, $26, 6, $EE, 8, $48, 6, $4C, 4, $6E, 2, $AE, 0
	dc.b	2, 0, 4, 2, 8, 2, $C, 2, $E

Pal_20072A:
	dcb.b	4,0
	dc.b	4, $44, 8, $88, $E, $40, 8, 0, $E, $EE, $E, $64, 0, 6, $E
	dc.b	$8E, 0, $8E, $A, $4E, 0, $EE, 0, $88, 0, $44, 0, $2E, 8, $46
	dcb.b	2,$E
	dcb.b	2,6
	dcb.b	2,0
	dc.b	6, $E6, $E, $E8, $A, $E, 0, $E, 6, $EE, 0, $8E, 0, $4C, 0
