...
byte_233B0C:
	incbin	"src/data/r61a/byte_233B0C.bin"
	even

byte_233B8C:
	incbin	"src/data/r61a/byte_233B8C.bin"
	even

byte_233C0C:
	incbin	"src/data/r61a/byte_233C0C.bin"
	even

byte_233D0C:
	incbin	"src/data/r61a/byte_233D0C.bin"
	even

byte_233E0C:
	incbin	"src/data/r61a/byte_233E0C.bin"
	even

byte_233F0C:
	incbin	"src/data/r61a/byte_233F0C.bin"
	even

byte_233F8C:
	incbin	"src/data/r61a/byte_233F8C.bin"
	even

byte_23400C:
	incbin	"src/data/r61a/byte_23400C.bin"
	even

byte_23408C:
	incbin	"src/data/r61a/byte_23408C.bin"
	even

LauncherGfx:
	incbin	"src/data/r61a/LauncherGfx.bin"
	even

FreezerGfx:
	incbin	"src/data/r61a/FreezerGfx.bin"
	even

IceBlockGfx:
	incbin	"src/data/r61a/IceBlockGfx.bin"
	even
...
StageMapNull:
	incbin	"src/data/r61a/StageMapNull.bin"
	even

StageMapUnk1:
	incbin	"src/data/r61a/StageMapUnk1.bin"
	even

StageMapUnk3:
	incbin	"src/data/r61a/StageMapUnk3.bin"
	even

StageMapUnk4:
	incbin	"src/data/r61a/StageMapUnk4.bin"
	even

StageMapUnk2:
	incbin	"src/data/r61a/StageMapUnk2.bin"
	even

StageMapUnk5:
	incbin	"src/data/r61a/StageMapUnk5.bin"
	even
...
byte_21D7A6:
	incbin	"src/data/r61a/byte_21D7A6.bin"
	even
...
PistonGfx:
	incbin	"src/data/r61a/PistonGfx.bin"
	even

PlatformGfxA:
	incbin	"src/data/r61a/PlatformGfxA.bin"
	even

PlatformGfxB:
	incbin	"src/data/r61a/PlatformGfxB.bin"
	even

PlatformGfxCD:
	incbin	"src/data/r61a/PlatformGfxCD.bin"
	even

BouncePlatformGfx:
	incbin	"src/data/r61a/BouncePlatformGfx.bin"
	even
...
BossDoorGfx:
	incbin	"src/data/r61a/BossDoorGfx.bin"
	even

CrusherGfx:
	incbin	"src/data/r61a/CrusherGfx.bin"
	even

CrusherGfxC:
	incbin	"src/data/r61a/CrusherGfxC.bin"
	even

TubeDoorGfx:
	incbin	"src/data/r61a/TubeDoorGfx.bin"
	even

ElectricOrbGfxA:
	incbin	"src/data/r61a/ElectricOrbGfxA.bin"
	even

ElectricOrbGfxB:
	incbin	"src/data/r61a/ElectricOrbGfxB.bin"
	even

ElectricOrbGfxC:
	incbin	"src/data/r61a/ElectricOrbGfxC.bin"
	even

ElectricOrbGfxD:
	incbin	"src/data/r61a/ElectricOrbGfxD.bin"
	even

BataPyonGfx:
	incbin	"src/data/r61a/BataPyonGfx.bin"
	even

PohBeeGfx:
	incbin	"src/data/r61a/PohBeeGfx.bin"
	even

MinomusiGfx:
	incbin	"src/data/r61a/MinomusiGfx.bin"
	even

SemiBombGfx:
	incbin	"src/data/r61a/SemiBombGfx.bin"
	even

SnakeBlocksGfx:
	incbin	"src/data/r61a/SnakeBlocksGfx.bin"
	even

SemiGfx:
	incbin	"src/data/r61a/SemiGfx.bin"
	even

SeesawGfx:
	incbin	"src/data/r61a/SeesawGfx.bin"
	even

EggmanStatueGfx:
	incbin	"src/data/r61a/EggmanStatueGfx.bin"
	even

SpikeBallGfx:
	incbin	"src/data/r61a/SpikeBallGfx.bin"
	even
