...
Padding1:
	if REGION=USA
		...
		dc.w	$BC1C, $7DE0, $0023, $213A, $A400, $0023, $34BC, $AD00
		...
		dc.w	$69A0, $0023, $B626, $6CC0, $0023, $CDC8, $6EC0, $0023
		dc.w	$D004, $70C0, $0023, $CADC, $71C0, $0023, $B9E6, $72C0
		dc.w	$0022, $F8FC, $75C0, $0023, $D59E, $78C0, $0023, $C440
		dc.w	$7D20, $0023, $D0C4, $8BA0, $0000, $0023
	endif

StageChunks:
	incbin	"maps/r62c/chunks.bin"
...
StageCollision:
	incbin	"maps/r62c/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r62c/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r62c/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r62c/blocks.nem"
	even

StageGfx:
	incbin	"maps/r62c/gfx.nem"
	even
...
Padding3:
	include	"Level/Wacky Workbench/Data/R62C Padding3 Shared Prefix.asm"
	if REGION=USA
