...
Padding1:
	if REGION=USA
	; R61B retains the tail of the USA R61A PLC tables before the fixed boundary.
	; These entries are leftover data, not the live R6 graphics-list graph.
LegacyPLCStd2Tail:
		dc.l	$0023A382
		dc.w	$6D40
		dc.l	$0023AF48
...
StageChunks:
	incbin	"maps/r61b/chunks.bin"

Padding2:
	incbin	"maps/r61a/chunks.bin",$E600,$400
...
StageCollision:
	incbin	"maps/r61b/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r61b/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r61b/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r61b/blocks.nem"
	even

StageGfx:
	incbin	"maps/r61b/gfx.nem"
	even
...
Padding3:
	include	"Level/Wacky Workbench/Data/Legacy Padding 3/Suffix 0530.asm"
