...
StageCollision:
	incbin	"maps/r62d/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r62d/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r62d/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r62d/blocks.nem"
	even

StageGfx:
	incbin	"maps/r62d/gfx.nem"
	even
...
Padding3:
	incbin	"../padding/r62d_e_3.bin",0,$20B8
