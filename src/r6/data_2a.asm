...
StageCollision:
	incbin	"maps/r62a/collision.bin"
	even
...
StageMapFg:
	incbin	"maps/r62a/foreground.bin"
	even

StageMapBg:
	incbin	"maps/r62a/background.bin"
	even
...
StageBlocks:
	incbin	"maps/r62a/blocks.nem"
	even

StageGfx:
	incbin	"maps/r62a/gfx.nem"
	even
...
Padding3:
	include	"Level/Wacky Workbench/Data/R62A Padding3 Prefix Head.asm"
