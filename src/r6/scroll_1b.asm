...
GetPlayerObject:
	...
	tst.b	use_player_2
	beq.s	R6ScrollGetPlayerObjectReturn
	lea	player_object_2,a6

R6ScrollGetPlayerObjectReturn:
	rts
...
; Stage-credit spawn coordinates (x/y pairs).
R6ScrollCreditsSpawnTable:
	dc.b	0
	dc.b	$50
	dc.b	3
	dc.b	$B0
...
R6ScrollInitStageSpawn:
	...
	tst.w	stage_demo
	bpl.s	R6ScrollInitDemoSpawn
	move.w	s1_credits_index,d0
	subq.w	#1,d0
	lsl.w	#2,d0
	lea	R6ScrollCreditsSpawnTable,a1
	adda.w	d0,a1
	bra.s	R6ScrollInitStorePlayerSpawn

; ------------------------------------------------------------------------------

R6ScrollInitDemoSpawn:
	move.w	stage_demo,d0
	lsl.w	#2,d0
	adda.w	d0,a1

R6ScrollInitStorePlayerSpawn:
	moveq	#0,d1
	move.w	(a1)+,d1
	move.w	d1,8(a6)
	moveq	#0,d0
...
R6ScrollFillBackgroundLinesSegment1:
	move.w	d0,(a1)+
	dbf	d6,R6ScrollFillBackgroundLinesSegment1
	move.w	scroll_bg3_x,d0
	neg.w	d0
	moveq	#1,d6

R6ScrollFillBackgroundLinesSegment2:
	move.w	d0,(a1)+
	dbf	d6,R6ScrollFillBackgroundLinesSegment2
	move.w	scroll_bg2_x,d0
	neg.w	d0
	moveq	#3,d6

R6ScrollFillBackgroundLinesSegment3:
	move.w	d0,(a1)+
	dbf	d6,R6ScrollFillBackgroundLinesSegment3
	move.w	scroll_bg3_x,d0
	neg.w	d0
	moveq	#$B,d6

R6ScrollFillBackgroundLinesSegment4:
	move.w	d0,(a1)+
	dbf	d6,R6ScrollFillBackgroundLinesSegment4
	move.w	scroll_bg2_x,d0
	neg.w	d0
	moveq	#3,d6

R6ScrollFillBackgroundLinesSegment5:
	move.w	d0,(a1)+
	dbf	d6,R6ScrollFillBackgroundLinesSegment5
	move.w	scroll_bg3_x,d0
	neg.w	d0
	moveq	#$B,d6

R6ScrollFillBackgroundLinesSegment6:
	move.w	d0,(a1)+
	dbf	d6,R6ScrollFillBackgroundLinesSegment6
	move.w	scroll_bg2_x,d0
	neg.w	d0
	moveq	#3,d6

R6ScrollFillBackgroundLinesSegment7:
	move.w	d0,(a1)+
	dbf	d6,R6ScrollFillBackgroundLinesSegment7
	move.w	scroll_bg3_x,d0
	neg.w	d0
	moveq	#$B,d6

R6ScrollFillBackgroundLinesSegment8:
	move.w	d0,(a1)+
	dbf	d6,R6ScrollFillBackgroundLinesSegment8
	move.w	scroll_bg2_x,d0
	neg.w	d0
	moveq	#3,d6

R6ScrollFillBackgroundLinesSegment9:
	move.w	d0,(a1)+
	dbf	d6,R6ScrollFillBackgroundLinesSegment9
	lea	scroll_lines,a1
...
R6ScrollBackgroundCurveSegment:
	...
	neg.w	d0
	moveq	#0,d5
	move.b	R6ScrollCurveSegmentLengths(pc,d6.w),d5

R6ScrollBackgroundCurveRepeat:
	move.w	d0,-(a1)
	dbf	d5,R6ScrollBackgroundCurveRepeat
	swap	d3
	add.l	d2,d3
	swap	d3
