...
; Scroll-layer pointers used while drawing pending rows.
...
; Background row to scroll-layer selectors (callers skip the sentinel byte).
...
; Scroll-layer pointers used while initializing the background tilemap.
