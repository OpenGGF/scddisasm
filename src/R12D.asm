...
; ------------------------------------------------------------------------------
	...
	include "src/r1/scroll_2d.asm"
	include "src/r1/stage_draw_2d.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r1/stage_data_load_2d.asm"
	...
	include "src/r1/debug_objects_2d.asm"
	...
	include "src/r1/collapse_data_2d.asm"
	include "src/objects/r1/platform.asm"
	include "src/objects/r1/v_door.asm"
	include "src/r1/section_gfx_2d.asm"
	...
	include "src/r1/stage_gfx_animate_2d.asm"
	include "src/r1/gfx_lists_2d.asm"
	include "src/r1/data_2d.asm"
