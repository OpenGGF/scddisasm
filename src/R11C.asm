...
; ------------------------------------------------------------------------------
	...
	include "src/r1/palette_cycle_c.asm"
	...
	include "src/r1/scroll_1c.asm"
	include "src/r1/stage_draw_1c.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r1/stage_data_load_1c.asm"
	...
	include "src/r1/debug_objects_1c.asm"
	...
	include "src/r1/collapse_data_1c.asm"
	include "src/objects/r1/platform.asm"
	include "src/objects/r1/v_door.asm"
	include "src/r1/section_gfx_1c.asm"
	...
	include "src/r1/stage_gfx_animate_1c.asm"
	include "src/r1/gfx_lists_1c.asm"
	include "src/r1/data_1c.asm"
