...
; ------------------------------------------------------------------------------
	...
	include "src/r6/palette_cycle_a.asm"
	...
	include "src/r6/scroll_2a.asm"
	include "src/r6/stage_draw_2a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r6/stage_data_load_2a.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r6/object_index_2.asm"
	...
	include "src/r6/debug_objects_2a.asm"
	include "src/common/object_spawn.asm"
	include "src/r6/stage_object_maps_2.asm"
	...
	include "src/r6/section_gfx_2a.asm"
	...
	include "src/r6/stage_gfx_animate_2a.asm"
	include "src/r6/gfx_lists_2a.asm"
	include "src/r6/data_2a.asm"
