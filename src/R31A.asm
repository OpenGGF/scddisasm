...
; ------------------------------------------------------------------------------
	...
	include "src/r3/palette_cycle_a.asm"
	...
	include "src/r3/scroll_1a.asm"
	include "src/r3/stage_draw_1a.asm"
	if STANDALONE<>0
		include	"standalone/block_write.asm"
	endif
	include "src/r3/stage_data_load_1a.asm"
	include "src/common/events.asm"
	include "src/common/object.asm"
	include "src/r3/object_index_1a.asm"
	...
	include "src/r3/debug_objects_1a.asm"
	include "src/common/object_spawn.asm"
	include "src/r3/stage_object_maps_1.asm"
	...
	include "src/r3/section_gfx_1a.asm"
	...
	include "src/objects/r3/intro.asm"
	...
	include "src/sprites/title_card_r3.asm"
	include "src/r3/stage_gfx_animate_1a.asm"
	include "src/r3/gfx_lists_1a.asm"
	include "src/r3/data_1a.asm"
