...
files=(
	IPX___.MMD SPX___.BIN BRAMINIT.MMD BRAMMAIN.MMD BRAMSUB.BIN MDINIT.MMD WARP__.MMD
	...
	ATTACK.MMD ATTACK.BIN THANKS_M.MMD THANKS_S.BIN THANKS_D.BIN COME__.MMD ENDING.MMD OPEN_M.MMD OPEN_S.BIN OPN.STM BADEND.STM GOODEND.STM PTEST.STM GOODEND.BIN BADEND.BIN PTEST.MMD PTEST.BIN
