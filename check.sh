...
files=(
	...
	ATTACK.MMD ATTACK.BIN THANKS_M.MMD THANKS_S.BIN THANKS_D.BIN COME__.MMD ENDING.MMD OPEN_M.MMD OPEN_S.BIN OPN.STM GOODEND.BIN BADEND.BIN PTEST.MMD PTEST.BIN
