...
data pending source decomposition and regional validation. The 38 padding
slices replaced so far, covering R8/R81D, R6, R12B/R12D, R4, R31B, R5, R7,
and R83D, were exact references or bounded slices of existing source-owned
data assets; 153 opaque padding slices totalling 843,288 bytes remain.
