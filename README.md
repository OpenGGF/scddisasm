...
data pending source decomposition and regional validation. The 132 padding
...
R12B/R12C/R12D pre-chunk data, R31B/R31C pre-chunk data,
...
59 opaque padding slices totalling 394,244 bytes remain.
